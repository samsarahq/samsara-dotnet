...
[TestFixture]
public class GetAssetRecoveryStateTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/preview/fleet/assets/device-recovery/id/recovery-state")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.PreviewApIs.GetAssetRecoveryStateAsync(
            new GetAssetRecoveryStateRequest { Id = "id" }
        );
