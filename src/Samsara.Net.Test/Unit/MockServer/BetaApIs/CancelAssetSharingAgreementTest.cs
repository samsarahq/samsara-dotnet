...
[TestFixture]
public class CancelAssetSharingAgreementTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/fleet/asset-sharing/agreements/cancel")
                    .WithParam("id", "id")
                    .UsingPost()
            )
            .RespondWith(
        ...
        var response = await Client.BetaApIs.CancelAssetSharingAgreementAsync(
