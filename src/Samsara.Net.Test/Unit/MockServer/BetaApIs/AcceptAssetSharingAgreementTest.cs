...
[TestFixture]
public class AcceptAssetSharingAgreementTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/fleet/asset-sharing/agreements/accept")
                    .WithParam("id", "id")
                    .UsingPost()
            )
            .RespondWith(
        ...
        var response = await Client.BetaApIs.AcceptAssetSharingAgreementAsync(
