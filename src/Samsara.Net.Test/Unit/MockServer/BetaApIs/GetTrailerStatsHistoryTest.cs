...
[TestFixture]
public class GetTrailerStatsHistoryTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/beta/fleet/trailers/stats/history")
        ...
        var response = await Client.BetaApIs.GetTrailerStatsHistoryAsync(
