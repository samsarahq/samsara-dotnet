...
[TestFixture]
public class GetFormSubmissionsStreamTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/form-submissions/stream")
        ...
        var response = await Client.Forms.GetFormSubmissionsStreamAsync(
