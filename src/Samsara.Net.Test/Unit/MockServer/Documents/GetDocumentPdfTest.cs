...
public class GetDocumentPdfTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        const string mockResponse = """
            {
              "data": {
                "completedAtTime": "2020-01-02T08:04:06.000Z",
                ...
                "jobStatus": "requested",
                "requestedAtTime": "2020-01-02T08:04:05.000Z"
              }
            }
            """;
        ...
        Assert.That(
            response,
            Is.EqualTo(JsonUtils.Deserialize<DocumentPdfQueryResponse>(mockResponse))
                .UsingDefaults()
        );
    }
}
