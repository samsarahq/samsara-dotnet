...
[TestFixture]
public class GetRoutesFeedTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/fleet/routes/audit-logs/feed")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.Routes.GetRoutesFeedAsync(new GetRoutesFeedRequest());
        Assert.That(
            response,
            Is.EqualTo(JsonUtils.Deserialize<RoutesGetRoutesFeedResponseBody>(mockResponse))
                .UsingDefaults()
        );
    }
}
