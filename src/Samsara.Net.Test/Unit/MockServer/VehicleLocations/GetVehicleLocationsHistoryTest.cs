...
[TestFixture]
public class GetVehicleLocationsHistoryTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/fleet/vehicles/locations/history")
        ...
        var response = await Client.VehicleLocations.GetVehicleLocationsHistoryAsync(
