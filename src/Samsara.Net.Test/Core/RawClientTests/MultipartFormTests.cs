...
namespace Samsara.Net.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static Samsara.Net.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new Samsara.Net.Core.MultipartFormRequest
        {
