...
namespace Samsara.Net.Machines;

public partial class MachinesClient
{
    private RawClient _client;

    internal MachinesClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// );
    /// </code></example>
    public async Task<V1MachineHistoryResponse> GetHistoryAsync(
    ...
    /// </code></example>
    public async Task<InlineResponse2008> ListAsync(
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
