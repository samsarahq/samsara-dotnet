...
public partial class DriverCoachAssignmentsClient
{
    private RawClient _client;

    internal DriverCoachAssignmentsClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// </summary>
    private async Task<DriverCoachAssignmentsGetDriverCoachAssignmentResponseBody> ListInternalAsync(
        DriverCoachAssignmentsListRequest request,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<DriverCoachAssignmentsGetDriverCoachAssignmentResponseBody>(
                    responseBody
                )!;
            }
    ...
    /// </code></example>
    public async Task<Pager<CoachAssignmentWithDriverExternalIdsResponseResponseBody>> ListAsync(
        DriverCoachAssignmentsListRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        var pager = await CursorPager<
            DriverCoachAssignmentsListRequest,
            RequestOptions?,
    ...
    /// );
    /// </code></example>
    public async Task<DriverCoachAssignmentsPutDriverCoachAssignmentResponseBody> UpdateAsync(
        DriverCoachAssignmentsUpdateRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        {
            _query["coachId"] = request.CoachId;
        }
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<DriverCoachAssignmentsPutDriverCoachAssignmentResponseBody>(
                    responseBody
                )!;
            }
            catch (JsonException e)
