...
public partial class DefectsClient
{
    private RawClient _client;

    internal DefectsClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// </summary>
    private async Task<DvirDefectStreamDefectsResponseBody> StreamInternalAsync(
        DefectsStreamRequest request,
    ...
    /// </code></example>
    public async Task<Pager<DefectsResponseDataResponseBody>> StreamAsync(
        DefectsStreamRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// </code></example>
    public async Task<DvirDefectGetDefectResponseBody> GetAsync(
        string id,
        DefectsGetRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<DvirDefectGetDefectResponseBody>(responseBody)!;
            }
            catch (JsonException e)
            {
                throw new SamsaraClientException("Failed to deserialize response", e);
    ...
    /// );
    /// </code></example>
    public async Task<DefectsResponse> HistoryAsync(
        DefectsHistoryRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </code></example>
    public async Task<DefectResponse> UpdateAsync(
        string id,
        DefectPatch request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
