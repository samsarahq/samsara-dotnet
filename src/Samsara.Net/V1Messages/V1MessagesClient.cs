...
namespace Samsara.Net.V1Messages;

public partial class V1MessagesClient
{
    private RawClient _client;

    internal V1MessagesClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// </code></example>
    public async Task<InlineResponse2005> ListAsync(
        V1MessagesListRequest request,
    ...
    )
    {
        ...
        {
            _query["durationMs"] = request.DurationMs.Value.ToString();
        }
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<InlineResponse2005>(responseBody)!;
            }
    ...
    /// );
    /// </code></example>
    public async Task<InlineResponse2006> CreateAsync(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<InlineResponse2006>(responseBody)!;
            }
            catch (JsonException e)
            {
                throw new SamsaraClientException("Failed to deserialize response", e);
