...
public partial class IssuesClient
{
    ...
    /// </summary>
    private async Task<IssuesGetIssuesStreamResponseBody> StreamInternalAsync(
        IssuesStreamRequest request,
    ...
    /// </code></example>
    public async Task<IssuesGetIssuesResponseBody> ListAsync(
    ...
    /// );
    /// </code></example>
    public async Task<IssuesPatchIssueResponseBody> UpdateAsync(
    ...
    /// </code></example>
    public async Task<Pager<IssueResponseObjectResponseBody>> StreamAsync(
        IssuesStreamRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
