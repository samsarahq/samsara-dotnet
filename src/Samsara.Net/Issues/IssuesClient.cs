...
public partial class IssuesClient : IIssuesClient
{
    ...
    private async Task<WithRawResponse<IssuesGetIssuesResponseBody>> GetIssuesAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<IssuesGetIssuesResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<IssuesGetIssuesResponseBody>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<IssuesPostIssueResponseBody>> PostIssueAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<IssuesPostIssueResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<IssuesPostIssueResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<IssuesPatchIssueResponseBody>> PatchIssueAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<IssuesPatchIssueResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<IssuesPatchIssueResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<IssuesGetIssuesStreamResponseBody>> GetIssuesStreamAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<IssuesGetIssuesStreamResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<IssuesGetIssuesStreamResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    /// </code></example>
    public WithRawResponseTask<IssuesGetIssuesResponseBody> GetIssuesAsync(
        GetIssuesRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<IssuesGetIssuesResponseBody>(
            GetIssuesAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<IssuesPostIssueResponseBody> PostIssueAsync(
        IssuesPostIssueRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<IssuesPostIssueResponseBody>(
            PostIssueAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<IssuesPatchIssueResponseBody> PatchIssueAsync(
        IssuesPatchIssueRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<IssuesPatchIssueResponseBody>(
            PatchIssueAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<IssuesGetIssuesStreamResponseBody> GetIssuesStreamAsync(
        GetIssuesStreamRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<IssuesGetIssuesStreamResponseBody>(
            GetIssuesStreamAsyncCore(request, options, cancellationToken)
        );
    }
}
