...
/// </summary>
[Serializable]
public record ReportsDatasetFieldResponseBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required ReportsDatasetFieldResponseBodyDataType DataType { get; set; }
    ...
    public ReportsDatasetFieldResponseBodyUnit? Unit { get; set; }
