...
/// </summary>
[Serializable]
public record WorkOrderWithTimeEntriesObjectResponseBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public WorkOrderWithTimeEntriesObjectResponseBodyPriority? Priority { get; set; }
