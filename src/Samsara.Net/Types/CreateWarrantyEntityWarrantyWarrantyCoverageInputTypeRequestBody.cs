...
/// </summary>
[Serializable]
public record CreateWarrantyEntityWarrantyWarrantyCoverageInputTypeRequestBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<CreateWarrantyEntityWarrantyWarrantyCoverageItemInputTypeRequestBody>? Exclusions { get; set; }

    /// <summary>
    /// Items explicitly covered by this coverage group.
    /// </summary>
    [JsonPropertyName("inclusions")]
    public IEnumerable<CreateWarrantyEntityWarrantyWarrantyCoverageItemInputTypeRequestBody>? Inclusions { get; set; }
