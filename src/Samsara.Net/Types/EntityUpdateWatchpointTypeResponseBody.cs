...
/// </summary>
[Serializable]
public record EntityUpdateWatchpointTypeResponseBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EntityUpdateWatchpointTypeResponseBodyMode Mode { get; set; }
    ...
    public required EntityUpdateWatchpointTypeResponseBodyObservationType ObservationType { get; set; }
    ...
    public required EntityUpdateWatchpointTypeResponseBodyStatus Status { get; set; }
