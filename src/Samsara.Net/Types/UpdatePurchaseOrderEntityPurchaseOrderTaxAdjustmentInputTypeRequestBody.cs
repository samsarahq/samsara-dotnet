...
/// </summary>
[Serializable]
public record UpdatePurchaseOrderEntityPurchaseOrderTaxAdjustmentInputTypeRequestBody
    : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public UpdatePurchaseOrderEntityPurchaseOrderMoneyInputTypeRequestBody? Money { get; set; }
