...
/// </summary>
[Serializable]
public record CreateWarrantyEntityWarrantyWarrantyCoverageTypeResponseBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<CreateWarrantyEntityWarrantyWarrantyCoverageItemTypeResponseBody>? Exclusions { get; set; }

    /// <summary>
    /// Items explicitly covered by this coverage group.
    /// </summary>
    [JsonPropertyName("inclusions")]
    public IEnumerable<CreateWarrantyEntityWarrantyWarrantyCoverageItemTypeResponseBody>? Inclusions { get; set; }
