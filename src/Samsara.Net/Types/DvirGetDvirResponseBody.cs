...
[Serializable]
public record DvirGetDvirResponseBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public DvirGetDvirResponseBodySafetyStatus? SafetyStatus { get; set; }
    ...
    public required DvirGetDvirResponseBodyType Type { get; set; }
