...
/// </summary>
[Serializable]
public record HosEldEventObjectResponseBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required long EldEventCode { get; set; }
    ...
    public long? EldEventRecordOrigin { get; set; }
    ...
    public long? EldEventRecordStatus { get; set; }
    ...
    public required long EldEventType { get; set; }
