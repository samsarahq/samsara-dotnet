...
/// </summary>
[Serializable]
public record HosViolationTriggerDetailsObjectRequestBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required HosViolationTriggerDetailsObjectRequestBodyViolation Violation { get; set; }
