...
public record EntityListUpcomingPreventiveMaintenanceTypeResponseBody : IJsonOnDeserialized
{
    ...
    public EntityUpcomingPreventativeMaintenanceAssetRefTypeResponseBody? Asset { get; set; }
    ...
    [JsonPropertyName("preventativeMaintenanceSchedule")]
    public EntityUpcomingPreventativeMaintenancePreventativeMaintenanceScheduleRefTypeResponseBody? PreventativeMaintenanceSchedule { get; set; }
    ...
    public EntityUpcomingPreventativeMaintenanceWorkOrderRefTypeResponseBody? WorkOrder { get; set; }
