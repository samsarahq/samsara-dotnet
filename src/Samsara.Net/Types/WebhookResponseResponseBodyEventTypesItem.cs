...
public readonly record struct WebhookResponseResponseBodyEventTypesItem : IStringEnum
{
    ...
    public static readonly WebhookResponseResponseBodyEventTypesItem MissingDvirPastDue = new(
    ...
    public static readonly WebhookResponseResponseBodyEventTypesItem ShipmentTrackingEvent = new(
        Values.ShipmentTrackingEvent
    );
    ...
    public static readonly WebhookResponseResponseBodyEventTypesItem VisualSearchMatch = new(
        Values.VisualSearchMatch
    );

    public static readonly WebhookResponseResponseBodyEventTypesItem WorkOrderCreatedOrChanged =
