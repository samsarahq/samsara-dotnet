...
/// </summary>
[Serializable]
public record TrailerGoaGatewayTinyResponseResponseBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required TrailerGoaGatewayTinyResponseResponseBodyModel Model { get; set; }
