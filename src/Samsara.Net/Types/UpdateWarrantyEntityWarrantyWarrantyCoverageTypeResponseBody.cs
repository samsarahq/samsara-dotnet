...
public record UpdateWarrantyEntityWarrantyWarrantyCoverageTypeResponseBody : IJsonOnDeserialized
{
    ...
    public IEnumerable<UpdateWarrantyEntityWarrantyWarrantyCoverageItemTypeResponseBody>? Exclusions { get; set; }

    /// <summary>
    /// Items explicitly covered by this coverage group.
    /// </summary>
    [JsonPropertyName("inclusions")]
    public IEnumerable<UpdateWarrantyEntityWarrantyWarrantyCoverageItemTypeResponseBody>? Inclusions { get; set; }
