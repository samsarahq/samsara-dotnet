...
/// </summary>
[Serializable]
public record FleetInstallerPhotoUploadCreateDataResponseBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required FleetInstallerPhotoUploadCreateDataResponseBodyFileFormatType FileFormatType { get; set; }
    ...
    public required FleetInstallerPhotoUploadCreateDataResponseBodyHardwareType HardwareType { get; set; }
    ...
    public required FleetInstallerPhotoUploadCreateDataResponseBodyPhotoType PhotoType { get; set; }

    /// <summary>
    /// Upload lifecycle state.  Valid values: `awaitingUpload`, `processing`, `finished`, `unknown`
    /// </summary>
    [JsonPropertyName("processingStatus")]
    public required FleetInstallerPhotoUploadCreateDataResponseBodyProcessingStatus ProcessingStatus { get; set; }
    ...
    public required FleetInstallerPhotoUploadContextResponseBody UploadContext { get; set; }
