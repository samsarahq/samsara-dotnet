...
/// </summary>
[Serializable]
public record EntityListPartInventoryTypeResponseBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EntityListPartInventoryPartDefinitionRefTypeResponseBody? PartSamsara { get; set; }

    [JsonPropertyName("place")]
    public EntityListPartInventoryPlaceRefTypeResponseBody? Place { get; set; }
