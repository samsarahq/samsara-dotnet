...
[Serializable]
public record WebhooksGetWebhookResponseBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<WebhooksGetWebhookResponseBodyEventTypesItem>? EventTypes { get; set; }
    ...
    public required WebhooksGetWebhookResponseBodyVersion Version { get; set; }
