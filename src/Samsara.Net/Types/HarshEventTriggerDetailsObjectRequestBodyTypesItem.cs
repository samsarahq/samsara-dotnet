...
public readonly record struct HarshEventTriggerDetailsObjectRequestBodyTypesItem : IStringEnum
{
    ...
    public static readonly HarshEventTriggerDetailsObjectRequestBodyTypesItem HaImpact = new(
        Values.HaImpact
    );
    ...
    public static readonly HarshEventTriggerDetailsObjectRequestBodyTypesItem HaProximityWarning =
