...
/// </summary>
[Serializable]
public record AmbientTemperatureDetailsObjectRequestBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required AmbientTemperatureDetailsObjectRequestBodyOperation Operation { get; set; }
