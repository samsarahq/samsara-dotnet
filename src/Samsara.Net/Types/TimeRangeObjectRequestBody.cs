...
/// </summary>
[Serializable]
public record TimeRangeObjectRequestBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<TimeRangeObjectRequestBodyDaysOfWeekItem> DaysOfWeek { get; set; } =
        new List<TimeRangeObjectRequestBodyDaysOfWeekItem>();
