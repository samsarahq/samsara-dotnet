...
/// </summary>
[Serializable]
public record ReadingTriggerContinuousValueObjectRequestBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required ReadingTriggerContinuousValueObjectRequestBodyOperation Operation { get; set; }
    ...
    public ReadingTriggerContinuousValueObjectRequestBodyUnit? Unit { get; set; }
