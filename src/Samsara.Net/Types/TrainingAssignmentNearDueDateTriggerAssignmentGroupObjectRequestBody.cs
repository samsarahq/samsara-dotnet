...
/// </summary>
[Serializable]
public record TrainingAssignmentNearDueDateTriggerAssignmentGroupObjectRequestBody
    : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required TrainingAssignmentNearDueDateTriggerAssignmentGroupObjectRequestBodyAssignmentGroupType AssignmentGroupType { get; set; }
