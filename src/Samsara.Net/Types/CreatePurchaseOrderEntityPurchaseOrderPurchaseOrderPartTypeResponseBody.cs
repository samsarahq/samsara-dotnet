...
/// </summary>
[Serializable]
public record CreatePurchaseOrderEntityPurchaseOrderPurchaseOrderPartTypeResponseBody
    : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public CreatePurchaseOrderEntityPurchaseOrderMoneyTypeResponseBody? UnitCost { get; set; }
