...
/// </summary>
[Serializable]
public record PostFuelPurchaseRequestBodyDiscountRequestBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostFuelPurchaseRequestBodyDiscountRequestBodyCurrency Currency { get; set; }
