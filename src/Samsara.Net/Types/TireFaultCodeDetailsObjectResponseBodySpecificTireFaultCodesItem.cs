...
[JsonConverter(
    typeof(EnumSerializer<TireFaultCodeDetailsObjectResponseBodySpecificTireFaultCodesItem>)
)]
public enum TireFaultCodeDetailsObjectResponseBodySpecificTireFaultCodesItem
{
