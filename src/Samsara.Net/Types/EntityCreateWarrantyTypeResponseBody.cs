...
/// </summary>
[Serializable]
public record EntityCreateWarrantyTypeResponseBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public CreateWarrantyEntityWarrantyWarrantyCoverageTypeResponseBody? BaseCoverage { get; set; }

    /// <summary>
    /// Additional coverage groups defined on this warranty.
    /// </summary>
    [JsonPropertyName("coverages")]
    public IEnumerable<CreateWarrantyEntityWarrantyWarrantyCoverageTypeResponseBody>? Coverages { get; set; }
    ...
    public IEnumerable<CreateWarrantyEntityWarrantyWarrantyExternalIdTypeResponseBody>? ExternalIds { get; set; }
    ...
    public EntityCreateWarrantyVendorRefTypeResponseBody? Vendor { get; set; }
