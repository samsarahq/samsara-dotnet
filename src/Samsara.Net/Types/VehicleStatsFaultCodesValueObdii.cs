...
/// </summary>
[Serializable]
public record VehicleStatsFaultCodesValueObdii : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<VehicleStatsFaultCodesValueObdiiDiagnosticTroubleCodes>? DiagnosticTroubleCodes { get; set; }
