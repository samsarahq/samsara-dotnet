...
/// </summary>
[Serializable]
public record EntityUpdateWarrantyClaimTypeResponseBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EntityUpdateWarrantyClaimAssetRefTypeResponseBody? Asset { get; set; }
    ...
    public IEnumerable<UpdateWarrantyClaimEntityWarrantyClaimWarrantyClaimExternalIdTypeResponseBody>? ExternalIds { get; set; }
    ...
    public IEnumerable<UpdateWarrantyClaimEntityWarrantyClaimWarrantyClaimLaborTypeResponseBody>? Labor { get; set; }

    [JsonPropertyName("linkedWarranty")]
    public EntityUpdateWarrantyClaimWarrantyRefTypeResponseBody? LinkedWarranty { get; set; }
    ...
    public UpdateWarrantyClaimEntityWarrantyClaimMoneyTypeResponseBody? OtherCost { get; set; }

    /// <summary>
    /// Parts being claimed.
    /// </summary>
    [JsonPropertyName("parts")]
    public IEnumerable<UpdateWarrantyClaimEntityWarrantyClaimWarrantyClaimPartTypeResponseBody>? Parts { get; set; }
    ...
    public IEnumerable<UpdateWarrantyClaimEntityWarrantyClaimClaimReimbursementTypeResponseBody>? Reimbursements { get; set; }
    ...
    public IEnumerable<UpdateWarrantyClaimEntityWarrantyClaimWarrantyClaimStatusHistoryTypeResponseBody>? StatusHistory { get; set; }
    ...
    public EntityUpdateWarrantyClaimVendorRefTypeResponseBody? WarrantyVendor { get; set; }
