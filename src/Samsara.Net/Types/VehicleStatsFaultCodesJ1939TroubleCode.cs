...
/// </summary>
[Serializable]
public record VehicleStatsFaultCodesJ1939TroubleCode : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public VehicleStatsFaultCodesVendorSpecificFields? VendorSpecificFields { get; set; }
