...
/// </summary>
[Serializable]
public record ListPurchaseOrdersEntityPurchaseOrderTaxAdjustmentTypeResponseBody
    : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public ListPurchaseOrdersEntityPurchaseOrderMoneyTypeResponseBody? Money { get; set; }
