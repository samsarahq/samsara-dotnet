...
/// </summary>
[Serializable]
public record OrderTaskRequestBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public AppointmentWindowRequestBody? AppointmentWindow { get; set; }
    ...
    public OrderTaskRequestBodyPosition? Position { get; set; }
