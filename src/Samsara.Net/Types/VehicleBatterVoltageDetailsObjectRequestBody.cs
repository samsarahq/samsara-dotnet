...
/// </summary>
[Serializable]
public record VehicleBatterVoltageDetailsObjectRequestBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required VehicleBatterVoltageDetailsObjectRequestBodyOperation Operation { get; set; }
