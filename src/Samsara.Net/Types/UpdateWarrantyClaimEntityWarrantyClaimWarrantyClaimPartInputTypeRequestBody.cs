...
/// </summary>
[Serializable]
public record UpdateWarrantyClaimEntityWarrantyClaimWarrantyClaimPartInputTypeRequestBody
    : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public UpdateWarrantyClaimEntityWarrantyClaimMoneyInputTypeRequestBody? Cost { get; set; }
    ...
    public required string PartDefinitionId { get; set; }
