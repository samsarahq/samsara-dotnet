...
[Serializable]
public record WebhooksPostWebhooksResponseBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<WebhooksPostWebhooksResponseBodyEventTypesItem>? EventTypes { get; set; }
    ...
    public required WebhooksPostWebhooksResponseBodyVersion Version { get; set; }
