...
/// </summary>
[Serializable]
public record EntityUpdateWarrantyTypeResponseBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public UpdateWarrantyEntityWarrantyWarrantyCoverageTypeResponseBody? BaseCoverage { get; set; }

    /// <summary>
    /// Additional coverage groups defined on this warranty.
    /// </summary>
    [JsonPropertyName("coverages")]
    public IEnumerable<UpdateWarrantyEntityWarrantyWarrantyCoverageTypeResponseBody>? Coverages { get; set; }
    ...
    public IEnumerable<UpdateWarrantyEntityWarrantyWarrantyExternalIdTypeResponseBody>? ExternalIds { get; set; }
