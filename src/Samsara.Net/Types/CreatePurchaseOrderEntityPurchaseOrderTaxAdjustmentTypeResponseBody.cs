...
/// </summary>
[Serializable]
public record CreatePurchaseOrderEntityPurchaseOrderTaxAdjustmentTypeResponseBody
    : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public CreatePurchaseOrderEntityPurchaseOrderMoneyTypeResponseBody? Money { get; set; }
