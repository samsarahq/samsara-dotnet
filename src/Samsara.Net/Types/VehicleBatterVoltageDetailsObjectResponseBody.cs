...
/// </summary>
[Serializable]
public record VehicleBatterVoltageDetailsObjectResponseBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required long BatteryVolts { get; set; }
    ...
    public required VehicleBatterVoltageDetailsObjectResponseBodyOperation Operation { get; set; }
