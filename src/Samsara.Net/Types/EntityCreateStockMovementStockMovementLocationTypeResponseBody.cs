...
/// </summary>
[Serializable]
public record EntityCreateStockMovementStockMovementLocationTypeResponseBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public string? PartSamsara { get; set; }
    ...
    public EntityCreateStockMovementMoneyTypeResponseBody? UnitCost { get; set; }
