...
/// </summary>
[Serializable]
public record EntityCreatePartInventoryLocationTypeResponseBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EntityCreatePartInventoryLocationPartDefinitionRefTypeResponseBody? PartSamsara { get; set; }

    [JsonPropertyName("place")]
    public EntityCreatePartInventoryLocationPlaceRefTypeResponseBody? Place { get; set; }
    ...
    public CreatePartInventoryLocationEntityPartInventoryLocationMoneyTypeResponseBody? UnitCost { get; set; }
