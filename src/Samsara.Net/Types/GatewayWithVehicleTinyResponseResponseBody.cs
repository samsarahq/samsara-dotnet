...
[Serializable]
public record GatewayWithVehicleTinyResponseResponseBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required GatewayWithVehicleTinyResponseResponseBodyModel Model { get; set; }
