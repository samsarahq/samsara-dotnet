...
/// </summary>
[Serializable]
public record EntityCreateWarrantyClaimTypeResponseBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EntityCreateWarrantyClaimAssetRefTypeResponseBody? Asset { get; set; }
    ...
    public IEnumerable<CreateWarrantyClaimEntityWarrantyClaimWarrantyClaimExternalIdTypeResponseBody>? ExternalIds { get; set; }
    ...
    public IEnumerable<CreateWarrantyClaimEntityWarrantyClaimWarrantyClaimLaborTypeResponseBody>? Labor { get; set; }

    [JsonPropertyName("linkedWarranty")]
    public EntityCreateWarrantyClaimWarrantyRefTypeResponseBody? LinkedWarranty { get; set; }
    ...
    public CreateWarrantyClaimEntityWarrantyClaimMoneyTypeResponseBody? OtherCost { get; set; }

    /// <summary>
    /// Parts being claimed.
    /// </summary>
    [JsonPropertyName("parts")]
    public IEnumerable<CreateWarrantyClaimEntityWarrantyClaimWarrantyClaimPartTypeResponseBody>? Parts { get; set; }
    ...
    public IEnumerable<CreateWarrantyClaimEntityWarrantyClaimClaimReimbursementTypeResponseBody>? Reimbursements { get; set; }
    ...
    public IEnumerable<CreateWarrantyClaimEntityWarrantyClaimWarrantyClaimStatusHistoryTypeResponseBody>? StatusHistory { get; set; }
    ...
    public EntityCreateWarrantyClaimVendorRefTypeResponseBody? WarrantyVendor { get; set; }
