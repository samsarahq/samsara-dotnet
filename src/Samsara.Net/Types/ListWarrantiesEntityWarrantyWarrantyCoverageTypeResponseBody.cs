...
/// </summary>
[Serializable]
public record ListWarrantiesEntityWarrantyWarrantyCoverageTypeResponseBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<ListWarrantiesEntityWarrantyWarrantyCoverageItemTypeResponseBody>? Exclusions { get; set; }

    /// <summary>
    /// Items explicitly covered by this coverage group.
    /// </summary>
    [JsonPropertyName("inclusions")]
    public IEnumerable<ListWarrantiesEntityWarrantyWarrantyCoverageItemTypeResponseBody>? Inclusions { get; set; }
