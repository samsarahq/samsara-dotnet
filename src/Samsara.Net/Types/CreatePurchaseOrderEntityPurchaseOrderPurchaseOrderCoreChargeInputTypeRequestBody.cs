...
/// </summary>
[Serializable]
public record CreatePurchaseOrderEntityPurchaseOrderPurchaseOrderCoreChargeInputTypeRequestBody
    : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required CreatePurchaseOrderEntityPurchaseOrderPurchaseOrderCoreChargeInputTypeRequestBodyCoreChargeStatus CoreChargeStatus { get; set; }
    ...
    public CreatePurchaseOrderEntityPurchaseOrderCoreRecoverabilityPolicyInputTypeRequestBody? RecoverabilityPolicy { get; set; }
    ...
    public CreatePurchaseOrderEntityPurchaseOrderMoneyInputTypeRequestBody? UnitCoreAmount { get; set; }
