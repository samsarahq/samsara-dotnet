...
/// </summary>
[Serializable]
public record UpdatePurchaseOrderEntityPurchaseOrderTaxAdjustmentTypeResponseBody
    : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public UpdatePurchaseOrderEntityPurchaseOrderMoneyTypeResponseBody? Money { get; set; }
