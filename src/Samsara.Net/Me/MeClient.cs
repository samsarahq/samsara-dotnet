...
namespace Samsara.Net.Me;

public partial class MeClient
{
    private RawClient _client;

    internal MeClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// </code></example>
    public async Task<OrganizationInfoResponse> GetAsync(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<OrganizationInfoResponse>(responseBody)!;
            }
