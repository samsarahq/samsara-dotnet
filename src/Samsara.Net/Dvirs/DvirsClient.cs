...
public partial class DvirsClient
{
    private RawClient _client;

    internal DvirsClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// </summary>
    private async Task<DvirGetDvirsResponseBody> StreamInternalAsync(
        DvirsStreamRequest request,
    ...
    /// </code></example>
    public async Task<Pager<DvirStreamResponseDataResponseBody>> StreamAsync(
        DvirsStreamRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// </code></example>
    public async Task<DvirGetDvirResponseBody> GetAsync(
        string id,
        DvirsGetRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<DvirGetDvirResponseBody>(responseBody)!;
            }
            catch (JsonException e)
            {
                throw new SamsaraException("Failed to deserialize response", e);
    ...
    /// );
    /// </code></example>
    public async Task<DvirResponse> CreateAsync(
    ...
    /// );
    /// </code></example>
    public async Task<DvirsListResponse> HistoryAsync(
        DvirsHistoryRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </code></example>
    public async Task<DvirResponse> UpdateAsync(
        string id,
