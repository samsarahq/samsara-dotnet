...
using Samsara.Net.FormSubmissions.PdfExports;

namespace Samsara.Net.FormSubmissions;

public partial class FormSubmissionsClient
{
    private RawClient _client;

    internal FormSubmissionsClient(RawClient client)
    {
        _client = client;
        PdfExports = new PdfExportsClient(_client);
    }

    public PdfExportsClient PdfExports { get; }
    ...
    /// </summary>
    private async Task<FormSubmissionsGetFormSubmissionsStreamResponseBody> StreamInternalAsync(
        FormSubmissionsStreamRequest request,
    ...
    /// </code></example>
    public async Task<FormSubmissionsGetFormSubmissionsResponseBody> ListAsync(
        FormSubmissionsListRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// );
    /// </code></example>
    public async Task<FormSubmissionsPostFormSubmissionResponseBody> CreateAsync(
    ...
    /// );
    /// </code></example>
    public async Task<FormSubmissionsPatchFormSubmissionResponseBody> UpdateAsync(
    ...
    /// );
    /// </code></example>
    public async Task<Pager<FormSubmissionResponseObjectResponseBody>> StreamAsync(
        FormSubmissionsStreamRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
