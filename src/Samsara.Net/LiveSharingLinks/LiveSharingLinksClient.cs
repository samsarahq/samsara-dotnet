...
public partial class LiveSharingLinksClient : ILiveSharingLinksClient
{
    ...
    private async Task<
        WithRawResponse<LiveSharingLinksGetLiveSharingLinksResponseBody>
    > GetLiveSharingLinksAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<LiveSharingLinksGetLiveSharingLinksResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<LiveSharingLinksGetLiveSharingLinksResponseBody>()
                {
                    Data = responseData,
    ...
    private async Task<
        WithRawResponse<LiveSharingLinksCreateLiveSharingLinkResponseBody>
    > CreateLiveSharingLinkAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<LiveSharingLinksCreateLiveSharingLinkResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<LiveSharingLinksUpdateLiveSharingLinkResponseBody>
    > UpdateLiveSharingLinkAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<LiveSharingLinksUpdateLiveSharingLinkResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    /// </code></example>
    public WithRawResponseTask<LiveSharingLinksGetLiveSharingLinksResponseBody> GetLiveSharingLinksAsync(
        GetLiveSharingLinksRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<LiveSharingLinksGetLiveSharingLinksResponseBody>(
            GetLiveSharingLinksAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<LiveSharingLinksCreateLiveSharingLinkResponseBody> CreateLiveSharingLinkAsync(
        LiveSharingLinksCreateLiveSharingLinkRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<LiveSharingLinksCreateLiveSharingLinkResponseBody>(
            CreateLiveSharingLinkAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<LiveSharingLinksUpdateLiveSharingLinkResponseBody> UpdateLiveSharingLinkAsync(
        LiveSharingLinksUpdateLiveSharingLinkRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<LiveSharingLinksUpdateLiveSharingLinkResponseBody>(
            UpdateLiveSharingLinkAsyncCore(request, options, cancellationToken)
        );
    }
}
