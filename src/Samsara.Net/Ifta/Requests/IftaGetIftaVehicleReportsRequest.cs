...
public record IftaGetIftaVehicleReportsRequest
{
    /// <summary>
    ...
    /// </summary>
    public IftaGetIftaVehicleReportsRequestMonth? Month { get; set; }
    ...
    /// </summary>
    public IftaGetIftaVehicleReportsRequestQuarter? Quarter { get; set; }
    ...
    /// </summary>
    public IftaGetIftaVehicleReportsRequestFuelType? FuelType { get; set; }
