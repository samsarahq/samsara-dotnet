...
[Serializable]
public record GetIftaVehicleReportsRequest
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public GetIftaVehicleReportsRequestMonth? Month { get; set; }
    ...
    /// </summary>
    [JsonIgnore]
    public GetIftaVehicleReportsRequestQuarter? Quarter { get; set; }
    ...
    /// </summary>
    [JsonIgnore]
    public GetIftaVehicleReportsRequestFuelType? FuelType { get; set; }
