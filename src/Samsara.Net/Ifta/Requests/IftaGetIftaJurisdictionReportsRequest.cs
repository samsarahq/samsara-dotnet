...
public record IftaGetIftaJurisdictionReportsRequest
{
    /// <summary>
    ...
    /// </summary>
    public IftaGetIftaJurisdictionReportsRequestMonth? Month { get; set; }
    ...
    /// </summary>
    public IftaGetIftaJurisdictionReportsRequestQuarter? Quarter { get; set; }
    ...
    /// </summary>
    public IftaGetIftaJurisdictionReportsRequestFuelType? FuelType { get; set; }
