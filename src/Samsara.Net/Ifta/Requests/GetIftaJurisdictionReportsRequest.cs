...
[Serializable]
public record GetIftaJurisdictionReportsRequest
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public GetIftaJurisdictionReportsRequestMonth? Month { get; set; }
    ...
    /// </summary>
    [JsonIgnore]
    public GetIftaJurisdictionReportsRequestQuarter? Quarter { get; set; }
    ...
    /// </summary>
    [JsonIgnore]
    public GetIftaJurisdictionReportsRequestFuelType? FuelType { get; set; }
