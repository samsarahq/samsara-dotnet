...
public record IftaGetVehicleReportsRequest
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public IftaGetVehicleReportsRequestMonth? Month { get; set; }
    ...
    /// </summary>
    [JsonIgnore]
    public IftaGetVehicleReportsRequestQuarter? Quarter { get; set; }
    ...
    /// </summary>
    [JsonIgnore]
    public IftaGetVehicleReportsRequestFuelType? FuelType { get; set; }
