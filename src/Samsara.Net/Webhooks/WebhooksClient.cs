...
public partial class WebhooksClient
{
    ...
    /// </code>
    /// </example>
    public async Task<WebhooksListWebhooksResponseBody> ListWebhooksAsync(
        WebhooksListWebhooksRequest request,
    ...
    /// </code>
    /// </example>
    public async Task<WebhooksPostWebhooksResponseBody> PostWebhooksAsync(
    ...
    /// </code>
    /// </example>
    public async Task<WebhooksGetWebhookResponseBody> GetWebhookAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// </code>
    /// </example>
    public async Task<WebhooksPatchWebhookResponseBody> PatchWebhookAsync(
        string id,
