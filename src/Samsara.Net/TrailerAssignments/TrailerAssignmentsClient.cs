...
public partial class TrailerAssignmentsClient
{
    ...
    /// </code>
    /// </example>
    public async Task<InlineResponse2007> V1GetAllTrailerAssignmentsAsync(
        TrailerAssignmentsV1GetAllTrailerAssignmentsRequest request,
    ...
    /// </code>
    /// </example>
    public async Task<V1TrailerAssignmentsResponse> V1GetFleetTrailerAssignmentsAsync(
        long trailerId,
        TrailerAssignmentsV1GetFleetTrailerAssignmentsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
