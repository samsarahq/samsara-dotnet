...
public partial class TrailerAssignmentsClient
{
    ...
    /// </summary>
    private async Task<InlineResponse2007> ListAllInternalAsync(
        TrailerAssignmentsListAllRequest request,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<InlineResponse2007>(responseBody)!;
            }
    ...
    /// </code></example>
    public async Task<Pager<V1TrailerAssignmentsResponse>> ListAllAsync(
        TrailerAssignmentsListAllRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        var pager = await CursorPager<
            TrailerAssignmentsListAllRequest,
            RequestOptions?,
            InlineResponse2007,
            string,
    ...
    /// </code></example>
    public async Task<V1TrailerAssignmentsResponse> ListAsync(
        long trailerId,
        TrailerAssignmentsListRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<V1TrailerAssignmentsResponse>(responseBody)!;
            }
            catch (JsonException e)
            {
                throw new SamsaraClientException("Failed to deserialize response", e);
