...
public record LegacyApIsGetDriversVehicleAssignmentsRequest
{
    /// <summary>
    ...
    /// </summary>
    public LegacyApIsGetDriversVehicleAssignmentsRequestDriverActivationStatus? DriverActivationStatus { get; set; }
