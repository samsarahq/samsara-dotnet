...
public partial class FormsClient : IFormsClient
{
    ...
    private async Task<
        WithRawResponse<FormSubmissionsGetFormSubmissionsResponseBody>
    > GetFormSubmissionsAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<FormSubmissionsGetFormSubmissionsResponseBody>()
                {
                    Data = responseData,
    ...
    private async Task<
        WithRawResponse<FormSubmissionsPostFormSubmissionResponseBody>
    > PostFormSubmissionAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<FormSubmissionsPostFormSubmissionResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<FormSubmissionsPostFormSubmissionResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<FormSubmissionsPatchFormSubmissionResponseBody>
    > PatchFormSubmissionAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<FormSubmissionsPatchFormSubmissionResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<FormSubmissionsGetFormSubmissionsPdfExportsResponseBody>
    > GetFormSubmissionsPdfExportsAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<FormSubmissionsGetFormSubmissionsPdfExportsResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<FormSubmissionsPostFormSubmissionsPdfExportsResponseBody>
    > PostFormSubmissionsPdfExportsAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<FormSubmissionsPostFormSubmissionsPdfExportsResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<FormSubmissionsGetFormSubmissionsStreamResponseBody>
    > GetFormSubmissionsStreamAsyncCore(
    ...
    )
    {
        var _queryString = new Samsara.Net.Core.QueryStringBuilder.Builder(capacity: 8)
            ...
            .Add("formTemplateIds", request.FormTemplateIds)
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<FormSubmissionsGetFormSubmissionsStreamResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<FormSubmissionsGetFormSubmissionsStreamResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<FormTemplatesGetFormTemplatesResponseBody>
    > GetFormTemplatesAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<FormTemplatesGetFormTemplatesResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<FormTemplatesGetFormTemplatesResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    /// </code></example>
    public WithRawResponseTask<FormSubmissionsGetFormSubmissionsResponseBody> GetFormSubmissionsAsync(
        GetFormSubmissionsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<FormSubmissionsGetFormSubmissionsResponseBody>(
            GetFormSubmissionsAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<FormSubmissionsPostFormSubmissionResponseBody> PostFormSubmissionAsync(
        FormSubmissionsPostFormSubmissionRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<FormSubmissionsPostFormSubmissionResponseBody>(
            PostFormSubmissionAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<FormSubmissionsPatchFormSubmissionResponseBody> PatchFormSubmissionAsync(
        FormSubmissionsPatchFormSubmissionRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<FormSubmissionsPatchFormSubmissionResponseBody>(
            PatchFormSubmissionAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<FormSubmissionsGetFormSubmissionsPdfExportsResponseBody> GetFormSubmissionsPdfExportsAsync(
        GetFormSubmissionsPdfExportsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<FormSubmissionsGetFormSubmissionsPdfExportsResponseBody>(
            GetFormSubmissionsPdfExportsAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<FormSubmissionsPostFormSubmissionsPdfExportsResponseBody> PostFormSubmissionsPdfExportsAsync(
        PostFormSubmissionsPdfExportsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<FormSubmissionsPostFormSubmissionsPdfExportsResponseBody>(
            PostFormSubmissionsPdfExportsAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<FormSubmissionsGetFormSubmissionsStreamResponseBody> GetFormSubmissionsStreamAsync(
        GetFormSubmissionsStreamRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<FormSubmissionsGetFormSubmissionsStreamResponseBody>(
            GetFormSubmissionsStreamAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<FormTemplatesGetFormTemplatesResponseBody> GetFormTemplatesAsync(
        GetFormTemplatesRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<FormTemplatesGetFormTemplatesResponseBody>(
            GetFormTemplatesAsyncCore(request, options, cancellationToken)
        );
    }
}
