...
[JsonConverter(
    typeof(EnumSerializer<DriverVehicleAssignmentsGetDriverVehicleAssignmentsRequestAssignmentType>)
)]
public enum DriverVehicleAssignmentsGetDriverVehicleAssignmentsRequestAssignmentType
{
