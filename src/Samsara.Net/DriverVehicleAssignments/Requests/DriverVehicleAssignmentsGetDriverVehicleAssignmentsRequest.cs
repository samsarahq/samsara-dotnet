...
public record DriverVehicleAssignmentsGetDriverVehicleAssignmentsRequest
{
    /// <summary>
    /// Option to filter by drivers or vehicles.  Valid values: `drivers`, `vehicles`
    /// </summary>
    public required DriverVehicleAssignmentsGetDriverVehicleAssignmentsRequestFilterBy FilterBy { get; set; }
    ...
    /// </summary>
    public DriverVehicleAssignmentsGetDriverVehicleAssignmentsRequestAssignmentType? AssignmentType { get; set; }
