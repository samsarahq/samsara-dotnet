...
public record DriverVehicleAssignmentsGetRequest
{
    /// <summary>
    /// Option to filter by drivers or vehicles.  Valid values: `drivers`, `vehicles`
    /// </summary>
    [JsonIgnore]
    public required DriverVehicleAssignmentsGetRequestFilterBy FilterBy { get; set; }
    ...
    /// </summary>
    [JsonIgnore]
    public DriverVehicleAssignmentsGetRequestAssignmentType? AssignmentType { get; set; }
