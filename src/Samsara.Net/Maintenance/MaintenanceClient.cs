...
public partial class MaintenanceClient : IMaintenanceClient
{
    ...
    private async Task<
        WithRawResponse<DvirDefectTypeGetDefectTypesResponseBody>
    > GetDefectTypesAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<DvirDefectTypeGetDefectTypesResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<DvirDefectTypeGetDefectTypesResponseBody>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<DvirDefectStreamDefectsResponseBody>> StreamDefectsAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<DvirDefectStreamDefectsResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<DvirDefectStreamDefectsResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<DvirDefectGetDefectResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<DvirDefectGetDefectResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<DvirGetDvirsResponseBody>> GetDvirsAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<DvirGetDvirsResponseBody>(responseBody)!;
                return new WithRawResponse<DvirGetDvirsResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<DvirGetDvirResponseBody>(responseBody)!;
                return new WithRawResponse<DvirGetDvirResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<DefectResponse>(responseBody)!;
                return new WithRawResponse<DefectResponse>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<DvirResponse>> CreateDvirAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<DvirResponse>(responseBody)!;
                return new WithRawResponse<DvirResponse>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<InlineResponse2004>> V1GetFleetMaintenanceListAsyncCore(
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<InlineResponse2004>(responseBody)!;
                return new WithRawResponse<InlineResponse2004>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    /// </code></example>
    public WithRawResponseTask<DvirDefectTypeGetDefectTypesResponseBody> GetDefectTypesAsync(
        GetDefectTypesRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<DvirDefectTypeGetDefectTypesResponseBody>(
            GetDefectTypesAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<DvirDefectStreamDefectsResponseBody> StreamDefectsAsync(
        StreamDefectsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<DvirDefectStreamDefectsResponseBody>(
            StreamDefectsAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<DvirGetDvirsResponseBody> GetDvirsAsync(
        GetDvirsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<DvirGetDvirsResponseBody>(
            GetDvirsAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<DvirResponse> CreateDvirAsync(
        CreateDvirRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<DvirResponse>(
            CreateDvirAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<InlineResponse2004> V1GetFleetMaintenanceListAsync(
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<InlineResponse2004>(
            V1GetFleetMaintenanceListAsyncCore(options, cancellationToken)
        );
    }
}
