...
public partial class ServiceTasksClient
{
    private RawClient _client;

    internal ServiceTasksClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// </code></example>
    public async Task<Pager<ServiceTaskDefinitionObjectResponseBody>> ListAsync(
        ServiceTasksListRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
