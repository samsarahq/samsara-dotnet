...
[Serializable]
public record ListUploadedMediaRequest
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<ListUploadedMediaRequestInputsItem> Inputs { get; set; } =
        new List<ListUploadedMediaRequestInputsItem>();
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<ListUploadedMediaRequestMediaTypesItem> MediaTypes { get; set; } =
        new List<ListUploadedMediaRequestMediaTypesItem>();
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<ListUploadedMediaRequestTriggerReasonsItem> TriggerReasons { get; set; } =
        new List<ListUploadedMediaRequestTriggerReasonsItem>();
