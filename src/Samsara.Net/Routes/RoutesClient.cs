...
using Samsara.Net.Routes.AuditLogs;
...
public partial class RoutesClient
{
    ...
    /// </summary>
    private async Task<RoutesFetchRoutesResponseBody> ListInternalAsync(
        RoutesListRequest request,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<RoutesFetchRoutesResponseBody>(responseBody)!;
            }
    ...
    /// );
    /// </code></example>
    public async Task<Pager<BaseRouteResponseObjectResponseBody>> ListAsync(
        RoutesListRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// );
    /// </code></example>
    public async Task<RoutesCreateRouteResponseBody> CreateAsync(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<RoutesCreateRouteResponseBody>(responseBody)!;
            }
            catch (JsonException e)
            {
                throw new SamsaraClientException("Failed to deserialize response", e);
    ...
    /// </code></example>
    public async Task<RoutesFetchRouteResponseBody> GetAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<RoutesFetchRouteResponseBody>(responseBody)!;
            }
            catch (JsonException e)
            {
                throw new SamsaraClientException("Failed to deserialize response", e);
    ...
    /// </code></example>
    public async Task<RoutesPatchRouteResponseBody> UpdateAsync(
        string id,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<RoutesPatchRouteResponseBody>(responseBody)!;
            }
            catch (JsonException e)
            {
                throw new SamsaraClientException("Failed to deserialize response", e);
