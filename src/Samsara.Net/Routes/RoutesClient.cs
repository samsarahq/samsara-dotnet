...
public partial class RoutesClient : IRoutesClient
{
    ...
    internal RoutesClient(RawClient client)
    {
        _client = client;
    }

    private async Task<WithRawResponse<RoutesFetchRoutesResponseBody>> FetchRoutesAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<RoutesFetchRoutesResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<RoutesFetchRoutesResponseBody>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<RoutesCreateRouteResponseBody>> CreateRouteAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<RoutesCreateRouteResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<RoutesCreateRouteResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<RoutesGetRoutesFeedResponseBody>> GetRoutesFeedAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<RoutesGetRoutesFeedResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<RoutesGetRoutesFeedResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<RoutesFetchRouteResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<RoutesFetchRouteResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<RoutesPatchRouteResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<RoutesPatchRouteResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<HubPlanRoutesListHubPlanRoutesResponseBody>
    > ListHubPlanRoutesAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<HubPlanRoutesListHubPlanRoutesResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<HubPlanRoutesListHubPlanRoutesResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<RoutesFetchRoutesResponseBody> FetchRoutesAsync(
        FetchRoutesRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<RoutesFetchRoutesResponseBody>(
            FetchRoutesAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<RoutesCreateRouteResponseBody> CreateRouteAsync(
        RoutesCreateRouteRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<RoutesCreateRouteResponseBody>(
            CreateRouteAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<RoutesGetRoutesFeedResponseBody> GetRoutesFeedAsync(
        GetRoutesFeedRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<RoutesGetRoutesFeedResponseBody>(
            GetRoutesFeedAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<HubPlanRoutesListHubPlanRoutesResponseBody> ListHubPlanRoutesAsync(
        ListHubPlanRoutesRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<HubPlanRoutesListHubPlanRoutesResponseBody>(
            ListHubPlanRoutesAsyncCore(request, options, cancellationToken)
        );
    }
