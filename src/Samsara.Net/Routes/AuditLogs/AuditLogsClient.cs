...
public partial class AuditLogsClient
{
    ...
    /// </code></example>
    public async Task<RoutesGetRoutesFeedResponseBody> GetFeedAsync(
        AuditLogsGetFeedRequest request,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<RoutesGetRoutesFeedResponseBody>(responseBody)!;
            }
