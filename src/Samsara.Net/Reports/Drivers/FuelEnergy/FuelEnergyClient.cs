...
public partial class FuelEnergyClient
{
    private RawClient _client;

    internal FuelEnergyClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// );
    /// </code></example>
    public async Task<FuelEnergyGetFuelEnergyDriverReportsResponseBody> GetAsync(
