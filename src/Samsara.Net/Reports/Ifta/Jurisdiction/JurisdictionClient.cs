...
public partial class JurisdictionClient
{
    private RawClient _client;

    internal JurisdictionClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// </code></example>
    public async Task<IftaGetIftaJurisdictionReportsResponseBody> GetAsync(
        JurisdictionGetRequest request,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<IftaGetIftaJurisdictionReportsResponseBody>(
                    responseBody
                )!;
            }
