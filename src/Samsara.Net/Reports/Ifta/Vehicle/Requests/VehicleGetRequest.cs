...
public record VehicleGetRequest
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public VehicleGetRequestMonth? Month { get; set; }
    ...
    /// </summary>
    [JsonIgnore]
    public VehicleGetRequestQuarter? Quarter { get; set; }
    ...
    /// </summary>
    [JsonIgnore]
    public VehicleGetRequestFuelType? FuelType { get; set; }
