...
namespace Samsara.Net.FuelPurchases;

public partial class FuelPurchasesClient
{
    private RawClient _client;

    internal FuelPurchasesClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// );
    /// </code></example>
    public async Task<FuelPurchasePostFuelPurchaseResponseBody> CreateAsync(
