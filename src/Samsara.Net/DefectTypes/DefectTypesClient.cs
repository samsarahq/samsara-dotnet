...
namespace Samsara.Net.DefectTypes;

public partial class DefectTypesClient
{
    private RawClient _client;

    internal DefectTypesClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// </summary>
    private async Task<DvirDefectTypeGetDefectTypesResponseBody> ListInternalAsync(
        DefectTypesListRequest request,
    ...
    /// </code></example>
    public async Task<Pager<DefectTypesResponseDataResponseBody>> ListAsync(
        DefectTypesListRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
