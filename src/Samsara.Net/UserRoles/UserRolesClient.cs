...
namespace Samsara.Net.UserRoles;

public partial class UserRolesClient
{
    private RawClient _client;

    internal UserRolesClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// </summary>
    private async Task<ListUserRolesResponse> ListInternalAsync(
        UserRolesListRequest request,
    ...
    /// </code></example>
    public async Task<Pager<UserRole>> ListAsync(
        UserRolesListRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
