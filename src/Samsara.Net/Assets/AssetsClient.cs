...
public partial class AssetsClient
{
    ...
    /// </code>
    /// </example>
    public async Task<InlineResponse2001> V1GetAllAssetsAsync(
    ...
    /// </code>
    /// </example>
    public async Task<InlineResponse2002> V1GetAllAssetCurrentLocationsAsync(
        AssetsV1GetAllAssetCurrentLocationsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </code>
    /// </example>
    public async Task<InlineResponse2003> V1GetAssetsReefersAsync(
        AssetsV1GetAssetsReefersRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </code>
    /// </example>
    public async Task<IEnumerable<V1AssetLocationResponseItem>> V1GetAssetLocationAsync(
        long assetId,
        AssetsV1GetAssetLocationRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </code>
    /// </example>
    public async Task<V1AssetReeferResponse> V1GetAssetReeferAsync(
        long assetId,
        AssetsV1GetAssetReeferRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
