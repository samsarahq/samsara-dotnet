...
public partial class AssetsClient : IAssetsClient
{
    ...
    {
        return new WithRawResponseTask<AssetsListAssetsResponseBody>(
            ListInternalAsyncCore(request, options, cancellationToken)
        );
    }

    private async Task<WithRawResponse<AssetsListAssetsResponseBody>> ListInternalAsyncCore(
        ListAssetsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<AssetsListAssetsResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<AssetsListAssetsResponseBody>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<AssetsCreateAssetResponseBody>> CreateAssetAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<AssetsCreateAssetResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<AssetsCreateAssetResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<AssetsUpdateAssetResponseBody>> UpdateAssetAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<AssetsUpdateAssetResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<AssetsUpdateAssetResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<InlineResponse2002>> V1GetAllAssetCurrentLocationsAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<InlineResponse2002>(responseBody)!;
                return new WithRawResponse<InlineResponse2002>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<InlineResponse2003>> V1GetAssetsReefersAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<InlineResponse2003>(responseBody)!;
                return new WithRawResponse<InlineResponse2003>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<AssetLocationsGetAssetLocationResponseBody>
    > GetAssetLocationAsyncCore(
        GetAssetLocationRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<AssetLocationsGetAssetLocationResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<AssetLocationsGetAssetLocationResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<AssetsGetAssetReeferResponseBody>> GetAssetReeferAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<AssetsGetAssetReeferResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<AssetsGetAssetReeferResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<IEnumerable<V1AssetLocationResponseItem>>(
                    responseBody
                )!;
                return new WithRawResponse<IEnumerable<V1AssetLocationResponseItem>>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<V1AssetReeferResponse>(responseBody)!;
                return new WithRawResponse<V1AssetReeferResponse>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    /// </code></example>
    public async Task<Pager<AssetResponseBody>> ListAsync(
        ListAssetsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// </code></example>
    public WithRawResponseTask<AssetsCreateAssetResponseBody> CreateAssetAsync(
        AssetsCreateAssetRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AssetsCreateAssetResponseBody>(
            CreateAssetAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<AssetsUpdateAssetResponseBody> UpdateAssetAsync(
        AssetsUpdateAssetRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AssetsUpdateAssetResponseBody>(
            UpdateAssetAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<InlineResponse2002> V1GetAllAssetCurrentLocationsAsync(
        V1GetAllAssetCurrentLocationsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<InlineResponse2002>(
            V1GetAllAssetCurrentLocationsAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<InlineResponse2003> V1GetAssetsReefersAsync(
        V1GetAssetsReefersRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<InlineResponse2003>(
            V1GetAssetsReefersAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<AssetLocationsGetAssetLocationResponseBody> GetAssetLocationAsync(
        GetAssetLocationRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AssetLocationsGetAssetLocationResponseBody>(
            GetAssetLocationAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<AssetsGetAssetReeferResponseBody> GetAssetReeferAsync(
        GetAssetReeferRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AssetsGetAssetReeferResponseBody>(
            GetAssetReeferAsyncCore(request, options, cancellationToken)
        );
    }
