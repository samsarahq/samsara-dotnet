...
public partial class LocationAndSpeedClient
{
    ...
    /// </summary>
    private async Task<LocationAndSpeedGetLocationAndSpeedResponseBody> StreamInternalAsync(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<LocationAndSpeedGetLocationAndSpeedResponseBody>(
                    responseBody
                )!;
            }
    ...
    /// </code></example>
    public async Task<Pager<LocationAndSpeedResponseResponseBody>> StreamAsync(
        LocationAndSpeedStreamRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
