...
public record UpdateDriverRequest
{
    ...
    public string? DeactivatedAtTime { get; set; }
    ...
    public UpdateDriverRequestDriverActivationStatus? DriverActivationStatus { get; set; }
    ...
    public UpdateDriverRequestLocale? Locale { get; set; }
