...
public partial class QrCodesClient
{
    private RawClient _client;

    internal QrCodesClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// </code></example>
    public async Task<DriverQrCodesGetDriversQrCodesResponseBody> ListAsync(
        QrCodesListRequest request,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<DriverQrCodesGetDriversQrCodesResponseBody>(
                    responseBody
                )!;
            }
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<DriverQrCodesCreateDriverQrCodeResponseBody>(
                    responseBody
                )!;
            }
            catch (JsonException e)
