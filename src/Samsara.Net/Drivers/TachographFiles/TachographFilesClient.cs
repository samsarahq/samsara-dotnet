...
namespace Samsara.Net.Drivers.TachographFiles;

public partial class TachographFilesClient
{
    private RawClient _client;

    internal TachographFilesClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// );
    /// </code></example>
    public async Task<TachographDriverFilesResponse> HistoryAsync(
        TachographFilesHistoryRequest request,
