...
public record FuelPurchasePostFuelPurchaseRequestBody
{
    ...
    public PostFuelPurchaseRequestBodyDiscountRequestBody? Discount { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("fuelGrade")]
    public FuelPurchasePostFuelPurchaseRequestBodyFuelGrade? FuelGrade { get; set; }
