...
using Samsara.Net.Documents.Pdfs;
...
public partial class DocumentsClient
{
    ...
    {
        _client = client;
        Pdfs = new PdfsClient(_client);
    }

    public PdfsClient Pdfs { get; }
    ...
    /// </summary>
    private async Task<DocumentsGetDocumentsResponseBody> ListInternalAsync(
    ...
    )
    {
        ...
        {
            _query["documentTypeId"] = request.DocumentTypeId;
        }
        if (request.QueryBy != null)
        {
            _query["queryBy"] = request.QueryBy;
        }
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<DocumentsGetDocumentsResponseBody>(responseBody)!;
            }
    ...
    /// );
    /// </code></example>
    public async Task<Pager<DocumentResponseObjectResponseBody>> ListAsync(
        DocumentsListRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<DocumentsPostDocumentResponseBody>(responseBody)!;
            }
            catch (JsonException e)
            {
                throw new SamsaraClientException("Failed to deserialize response", e);
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<DocumentsGetDocumentResponseBody>(responseBody)!;
            }
            catch (JsonException e)
            {
                throw new SamsaraClientException("Failed to deserialize response", e);
