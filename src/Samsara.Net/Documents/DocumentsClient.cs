...
public partial class DocumentsClient : IDocumentsClient
{
    ...
    private async Task<
        WithRawResponse<DocumentTypesGetDocumentTypesResponseBody>
    > GetDocumentTypesAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<DocumentTypesGetDocumentTypesResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<DocumentTypesGetDocumentTypesResponseBody>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<DocumentsGetDocumentsResponseBody>> GetDocumentsAsyncCore(
    ...
    )
    {
        var _queryString = new Samsara.Net.Core.QueryStringBuilder.Builder(capacity: 5)
            ...
            .Add("after", request.After)
            .Add("documentTypeId", request.DocumentTypeId)
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<DocumentsGetDocumentsResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<DocumentsGetDocumentsResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<DocumentsPostDocumentResponseBody>> PostDocumentAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<DocumentsPostDocumentResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<DocumentsPostDocumentResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<DocumentPdfGenerationResponse>> GenerateDocumentPdfAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<DocumentPdfGenerationResponse>(
                    responseBody
                )!;
                return new WithRawResponse<DocumentPdfGenerationResponse>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<DocumentPdfQueryResponse>(responseBody)!;
                return new WithRawResponse<DocumentPdfQueryResponse>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<DocumentsGetDocumentResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<DocumentsGetDocumentResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    /// </code></example>
    public WithRawResponseTask<DocumentTypesGetDocumentTypesResponseBody> GetDocumentTypesAsync(
        GetDocumentTypesRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<DocumentTypesGetDocumentTypesResponseBody>(
            GetDocumentTypesAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<DocumentsGetDocumentsResponseBody> GetDocumentsAsync(
        GetDocumentsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<DocumentsGetDocumentsResponseBody>(
            GetDocumentsAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<DocumentsPostDocumentResponseBody> PostDocumentAsync(
        DocumentsPostDocumentRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<DocumentsPostDocumentResponseBody>(
            PostDocumentAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<DocumentPdfGenerationResponse> GenerateDocumentPdfAsync(
        DocumentPdfGenerationRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<DocumentPdfGenerationResponse>(
            GenerateDocumentPdfAsyncCore(request, options, cancellationToken)
        );
    }
