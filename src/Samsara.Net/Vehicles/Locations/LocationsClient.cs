...
namespace Samsara.Net.Vehicles.Locations;
...
public partial class LocationsClient
{
    ...
    /// </summary>
    private async Task<VehicleLocationsResponse> ListInternalAsync(
    ...
    /// </summary>
    private async Task<VehicleLocationsListResponse> FeedInternalAsync(
    ...
    /// To use this endpoint, select **Read Vehicle Statistics** under the Vehicle category when creating or editing an API token. &lt;a href="https://developers.samsara.com/docs/authentication#scopes-for-api-tokens" target="_blank"&gt;Learn More.&lt;/a&gt;
    /// </summary>
    private async Task<VehicleLocationsListResponse> HistoryInternalAsync(
    ...
    /// </code></example>
    public async Task<Pager<VehicleLocationsResponseData>> ListAsync(
        LocationsListRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// </code></example>
    public async Task<Pager<VehicleLocationsListResponseData>> FeedAsync(
        LocationsFeedRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// );
    /// </code></example>
    public async Task<Pager<VehicleLocationsListResponseData>> HistoryAsync(
        LocationsHistoryRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
