...
public record StatsFeedRequest
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<StatsFeedRequestTypesItem> Types { get; set; } =
        new List<StatsFeedRequestTypesItem>();
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<StatsFeedRequestDecorationsItem> Decorations { get; set; } =
        new List<StatsFeedRequestDecorationsItem>();
