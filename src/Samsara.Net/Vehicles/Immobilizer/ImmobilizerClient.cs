...
namespace Samsara.Net.Vehicles.Immobilizer;

public partial class ImmobilizerClient
{
    private RawClient _client;

    internal ImmobilizerClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// </summary>
    private async Task<EngineImmobilizerGetEngineImmobilizerStatesResponseBody> StreamInternalAsync(
        ImmobilizerStreamRequest request,
    ...
    /// );
    /// </code></example>
    public async Task<Pager<EngineImmobilizerStateResponseBody>> StreamAsync(
        ImmobilizerStreamRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
