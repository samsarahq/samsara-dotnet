...
public partial class InputsClient
{
    ...
    /// </summary>
    private async Task<AssetsInputsGetAssetsInputsResponseBody> StreamInternalAsync(
    ...
    /// );
    /// </code></example>
    public async Task<Pager<AssetsInputsResponseResponseBody>> StreamAsync(
        InputsStreamRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
