...
public partial class LiveSharesClient
{
    private RawClient _client;

    internal LiveSharesClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// </summary>
    private async Task<LiveSharingLinksGetLiveSharingLinksResponseBody> ListInternalAsync(
        LiveSharesListRequest request,
    ...
    /// </code></example>
    public async Task<Pager<LiveSharingLinkFullResponseObjectResponseBody>> ListAsync(
        LiveSharesListRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    public async global::System.Threading.Tasks.Task DeleteAsync(
        LiveSharesDeleteRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
