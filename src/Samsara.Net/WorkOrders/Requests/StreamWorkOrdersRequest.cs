...
[Serializable]
public record StreamWorkOrdersRequest
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<StreamWorkOrdersRequestWorkOrderStatusesItem> WorkOrderStatuses { get; set; } =
        new List<StreamWorkOrdersRequestWorkOrderStatusesItem>();
