...
public partial class ComplianceClient
{
    ...
    internal ComplianceClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// </code></example>
    public async Task<SettingsGetComplianceSettingsResponseBody> GetAsync(
    ...
    /// </code></example>
    public async Task<SettingsPatchComplianceSettingsResponseBody> UpdateAsync(
