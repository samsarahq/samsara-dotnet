...
namespace Samsara.Net.Settings.DriverApp;

public partial class DriverAppClient
{
    private RawClient _client;

    internal DriverAppClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// </code></example>
    public async Task<SettingsGetDriverAppSettingsResponseBody> GetAsync(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<SettingsGetDriverAppSettingsResponseBody>(
                    responseBody
                )!;
            }
    ...
    /// </code></example>
    public async Task<SettingsPatchDriverAppSettingsResponseBody> UpdateAsync(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                return JsonUtils.Deserialize<SettingsPatchDriverAppSettingsResponseBody>(
                    responseBody
                )!;
            }
            catch (JsonException e)
