...
public partial class IncidentsClient
{
    ...
    internal IncidentsClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// </summary>
    private async Task<AlertsGetIncidentsResponseBody> StreamInternalAsync(
        IncidentsStreamRequest request,
    ...
    /// </code></example>
    public async Task<Pager<GetWorkflowIncidentResponseObjectResponseBody>> StreamAsync(
        IncidentsStreamRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
