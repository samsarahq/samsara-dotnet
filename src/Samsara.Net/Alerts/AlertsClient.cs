...
public partial class AlertsClient : IAlertsClient
{
    ...
    private async Task<
        WithRawResponse<AlertsGetConfigurationsResponseBody>
    > GetConfigurationsAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<AlertsGetConfigurationsResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<AlertsGetConfigurationsResponseBody>()
                {
                    Data = responseData,
    ...
    private async Task<
        WithRawResponse<AlertsPostConfigurationsResponseBody>
    > PostConfigurationsAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<AlertsPostConfigurationsResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<AlertsPostConfigurationsResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<AlertsPatchConfigurationsResponseBody>
    > PatchConfigurationsAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<AlertsPatchConfigurationsResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<AlertsPatchConfigurationsResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<AlertsGetIncidentsResponseBody>> GetIncidentsAsyncCore(
    ...
    )
    {
        var _queryString = new Samsara.Net.Core.QueryStringBuilder.Builder(capacity: 4)
            ...
            .Add("configurationIds", request.ConfigurationIds)
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<AlertsGetIncidentsResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<AlertsGetIncidentsResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    /// </code></example>
    public WithRawResponseTask<AlertsGetConfigurationsResponseBody> GetConfigurationsAsync(
        GetConfigurationsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AlertsGetConfigurationsResponseBody>(
            GetConfigurationsAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<AlertsPostConfigurationsResponseBody> PostConfigurationsAsync(
        AlertsPostConfigurationsRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AlertsPostConfigurationsResponseBody>(
            PostConfigurationsAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<AlertsPatchConfigurationsResponseBody> PatchConfigurationsAsync(
        AlertsPatchConfigurationsRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AlertsPatchConfigurationsResponseBody>(
            PatchConfigurationsAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<AlertsGetIncidentsResponseBody> GetIncidentsAsync(
        GetIncidentsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AlertsGetIncidentsResponseBody>(
            GetIncidentsAsyncCore(request, options, cancellationToken)
        );
    }
}
