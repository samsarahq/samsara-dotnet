...
public record PreviewApIsListUploadedMediaRequest
{
    /// <summary>
    ...
    /// </summary>
    public IEnumerable<PreviewApIsListUploadedMediaRequestInputsItem> Inputs { get; set; } =
        new List<PreviewApIsListUploadedMediaRequestInputsItem>();
    ...
    /// </summary>
    public IEnumerable<PreviewApIsListUploadedMediaRequestTriggerReasonsItem> TriggerReasons { get; set; } =
        new List<PreviewApIsListUploadedMediaRequestTriggerReasonsItem>();
