...
[Serializable]
public record EntityWarrantiesServiceCreateWarrantyRequestBody
{
    [JsonPropertyName("baseCoverage")]
    public CreateWarrantyEntityWarrantyWarrantyCoverageInputTypeRequestBody? BaseCoverage { get; set; }

    /// <summary>
    /// Additional coverage groups defined on this warranty.
    /// </summary>
    [JsonPropertyName("coverages")]
    public IEnumerable<CreateWarrantyEntityWarrantyWarrantyCoverageInputTypeRequestBody>? Coverages { get; set; }
    ...
    public IEnumerable<CreateWarrantyEntityWarrantyWarrantyExternalIdInputTypeRequestBody>? ExternalIds { get; set; }
