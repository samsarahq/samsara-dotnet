...
public partial class TrailersClient : ITrailersClient
{
    ...
    internal TrailersClient(RawClient client)
    {
        _client = client;
    }

    private async Task<WithRawResponse<TrailersListTrailersResponseBody>> ListTrailersAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<TrailersListTrailersResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<TrailersListTrailersResponseBody>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<TrailersCreateTrailerResponseBody>> CreateTrailerAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<TrailersCreateTrailerResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<TrailersCreateTrailerResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    BaseUrl = _client.Options.BaseUrl,
                    Method = HttpMethod.Get,
                    Path = "fleet/trailers/stats/feed",
                    QueryString = _queryString,
                    Headers = _headers,
                    Options = options,
                },
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    BaseUrl = _client.Options.BaseUrl,
                    Method = HttpMethod.Get,
                    Path = "fleet/trailers/stats/history",
                    QueryString = _queryString,
                    Headers = _headers,
                    Options = options,
                },
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<TrailersGetTrailerResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<TrailersGetTrailerResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<TrailersUpdateTrailerResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<TrailersUpdateTrailerResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    /// </code></example>
    public WithRawResponseTask<TrailersListTrailersResponseBody> ListTrailersAsync(
        ListTrailersRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<TrailersListTrailersResponseBody>(
            ListTrailersAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<TrailersCreateTrailerResponseBody> CreateTrailerAsync(
        TrailersCreateTrailerRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<TrailersCreateTrailerResponseBody>(
            CreateTrailerAsyncCore(request, options, cancellationToken)
        );
    }
