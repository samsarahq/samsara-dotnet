...
using Samsara.Net.Beta.Fleet;
using Samsara.Net.Beta.Inputs;
using Samsara.Net.Beta.Jobs;
...
public partial class BetaClient
{
    ...
    internal BetaClient(RawClient client)
    {
        _client = client;
        Assets = new AssetsClient(_client);
        Inputs = new InputsClient(_client);
        Aemp = new AempClient(_client);
