...
namespace Samsara.Net.Beta.Aemp;

public partial class AempClient
{
    private RawClient _client;

    internal AempClient(RawClient client)
    {
        _client = client;
    }
    ...
    /// </code>
    /// </example>
    public async Task<AempEquipmentGetAempEquipmentListResponseBody> GetAsync(
        string pageNumber,
