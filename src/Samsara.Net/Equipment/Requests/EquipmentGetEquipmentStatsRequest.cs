...
public record EquipmentGetEquipmentStatsRequest
{
    /// <summary>
    ...
    /// </summary>
    public IEnumerable<EquipmentGetEquipmentStatsRequestTypesItem> Types { get; set; } =
        new List<EquipmentGetEquipmentStatsRequestTypesItem>();
