...
public record EquipmentGetEquipmentStatsFeedRequest
{
    /// <summary>
    ...
    /// </summary>
    public IEnumerable<EquipmentGetEquipmentStatsFeedRequestTypesItem> Types { get; set; } =
        new List<EquipmentGetEquipmentStatsFeedRequestTypesItem>();
