...
[Serializable]
public record GetEquipmentStatsFeedRequest
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<GetEquipmentStatsFeedRequestTypesItem> Types { get; set; } =
        new List<GetEquipmentStatsFeedRequestTypesItem>();
