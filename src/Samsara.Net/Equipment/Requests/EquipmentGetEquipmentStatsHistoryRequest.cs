...
public record EquipmentGetEquipmentStatsHistoryRequest
{
    /// <summary>
    ...
    /// </summary>
    public IEnumerable<EquipmentGetEquipmentStatsHistoryRequestTypesItem> Types { get; set; } =
        new List<EquipmentGetEquipmentStatsHistoryRequestTypesItem>();
