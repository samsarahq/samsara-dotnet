...
[Serializable]
public record GetEquipmentStatsHistoryRequest
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<GetEquipmentStatsHistoryRequestTypesItem> Types { get; set; } =
        new List<GetEquipmentStatsHistoryRequestTypesItem>();
