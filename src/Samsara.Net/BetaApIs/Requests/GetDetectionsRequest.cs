...
[Serializable]
public record GetDetectionsRequest
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<string> DetectionBehaviorLabels { get; set; } = new List<string>();
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<string> InboxFilterReason { get; set; } = new List<string>();
