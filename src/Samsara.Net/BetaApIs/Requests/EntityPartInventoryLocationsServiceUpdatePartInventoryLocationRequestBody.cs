...
[Serializable]
public record EntityPartInventoryLocationsServiceUpdatePartInventoryLocationRequestBody
{
    /// <summary>
    ...
    public UpdatePartInventoryLocationEntityPartInventoryLocationMoneyInputTypeRequestBody? UnitCost { get; set; }
