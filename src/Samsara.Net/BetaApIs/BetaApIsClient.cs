...
public partial class BetaApIsClient : IBetaApIsClient
{
    ...
    private async Task<
        WithRawResponse<AgentStudioVoiceSessionsGetVoiceSessionsResponseBody>
    > GetVoiceSessionsAsyncCore(
    ...
    )
    {
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    ...
                    Path = "agent-studio/voice-sessions",
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<AgentStudioVoiceSessionsGetVoiceSessionsResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<AgentStudioVoiceSessionsGetVoiceSessionsResponseBody>()
                {
                    Data = responseData,
    ...
    private async Task<
        WithRawResponse<AgentStudioVoiceSessionsGetVoiceSessionsStreamResponseBody>
    > GetVoiceSessionsStreamAsyncCore(
    ...
    )
    {
        var _queryString = new Samsara.Net.Core.QueryStringBuilder.Builder(capacity: 8)
            ...
            .Add("agentIds", request.AgentIds)
            .Add("vehicleIds", request.VehicleIds)
            .Add("driverIds", request.DriverIds)
            .Add("sessionStatus", request.SessionStatus)
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    BaseUrl = _client.Options.BaseUrl,
                    Method = HttpMethod.Get,
                    Path = "agent-studio/voice-sessions/stream",
                    QueryString = _queryString,
                    Headers = _headers,
                    Options = options,
                },
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<AgentStudioVoiceSessionsGetVoiceSessionsStreamResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<AgentStudioVoiceSessionsGetVoiceSessionsStreamResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<AssetSharingAgreementsListAssetSharingAgreementsResponseBody>
    > ListAssetSharingAgreementsAsyncCore(
    ...
    )
    {
        var _queryString = new Samsara.Net.Core.QueryStringBuilder.Builder(capacity: 4)
            .Add("ids", request.Ids)
            .Add("statusIn", request.StatusIn)
            .Add("roleIn", request.RoleIn)
            .Add("after", request.After)
            .MergeAdditional(options?.AdditionalQueryParameters)
            .Build();
        var _headers = await new Samsara.Net.Core.HeadersBuilder.Builder()
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    BaseUrl = _client.Options.BaseUrl,
                    Method = HttpMethod.Get,
                    Path = "fleet/asset-sharing/agreements",
                    QueryString = _queryString,
                    Headers = _headers,
                    Options = options,
                },
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<AssetSharingAgreementsListAssetSharingAgreementsResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<AssetSharingAgreementsListAssetSharingAgreementsResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<AssetSharingAgreementsCreateAssetSharingAgreementResponseBody>
    > CreateAssetSharingAgreementAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<AssetSharingAgreementsCreateAssetSharingAgreementResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<AssetSharingAgreementsCreateAssetSharingAgreementResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<AssetSharingAgreementsAcceptAssetSharingAgreementResponseBody>
    > AcceptAssetSharingAgreementAsyncCore(
    ...
    )
    {
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    BaseUrl = _client.Options.BaseUrl,
                    Method = HttpMethod.Post,
                    Path = "fleet/asset-sharing/agreements/accept",
                    QueryString = _queryString,
                    Headers = _headers,
                    Options = options,
                },
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<AssetSharingAgreementsAcceptAssetSharingAgreementResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<AssetSharingAgreementsAcceptAssetSharingAgreementResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<AssetSharingAgreementsListSharedAssetsResponseBody>
    > ListSharedAssetsAsyncCore(
    ...
    )
    {
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    BaseUrl = _client.Options.BaseUrl,
                    Method = HttpMethod.Get,
                    Path = "fleet/asset-sharing/agreements/assets",
                    QueryString = _queryString,
                    Headers = _headers,
                    Options = options,
                },
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<AssetSharingAgreementsListSharedAssetsResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<AssetSharingAgreementsListSharedAssetsResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<AssetSharingAgreementsCreateSharedAssetsBatchResponseBody>
    > CreateSharedAssetsBatchAsyncCore(
    ...
    )
    {
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    BaseUrl = _client.Options.BaseUrl,
                    Method = HttpMethod.Post,
                    Path = "fleet/asset-sharing/agreements/assets/batch",
                    Body = request,
                    QueryString = _queryString,
                    Headers = _headers,
                    ContentType = "application/json",
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<AssetSharingAgreementsCreateSharedAssetsBatchResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<AssetSharingAgreementsCreateSharedAssetsBatchResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<AssetSharingAgreementsUpdateSharedAssetsBatchResponseBody>
    > UpdateSharedAssetsBatchAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<AssetSharingAgreementsUpdateSharedAssetsBatchResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<AssetSharingAgreementsUpdateSharedAssetsBatchResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<AssetSharingAgreementsCancelSharedAssetsBatchResponseBody>
    > CancelSharedAssetsBatchAsyncCore(
    ...
    )
    {
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    BaseUrl = _client.Options.BaseUrl,
                    Method = HttpMethod.Post,
                    Path = "fleet/asset-sharing/agreements/assets/cancel/batch",
                    Body = request,
                    Headers = _headers,
                    ContentType = "application/json",
                    Options = options,
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<AssetSharingAgreementsCancelSharedAssetsBatchResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<AssetSharingAgreementsCancelSharedAssetsBatchResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<AssetSharingAgreementsCancelAssetSharingAgreementResponseBody>
    > CancelAssetSharingAgreementAsyncCore(
    ...
    )
    {
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    BaseUrl = _client.Options.BaseUrl,
                    Method = HttpMethod.Post,
                    Path = "fleet/asset-sharing/agreements/cancel",
                    QueryString = _queryString,
                    Headers = _headers,
                    Options = options,
                },
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<AssetSharingAgreementsCancelAssetSharingAgreementResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<AssetSharingAgreementsCancelAssetSharingAgreementResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<AssetSharingAgreementsRejectAssetSharingAgreementResponseBody>
    > RejectAssetSharingAgreementAsyncCore(
    ...
    )
    {
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    BaseUrl = _client.Options.BaseUrl,
                    Method = HttpMethod.Post,
                    Path = "fleet/asset-sharing/agreements/reject",
                    QueryString = _queryString,
                    Headers = _headers,
                    Options = options,
                },
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<AssetSharingAgreementsRejectAssetSharingAgreementResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<AssetSharingAgreementsRejectAssetSharingAgreementResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<AssetAssignmentsListAssetAssignmentsResponseBody>
    > ListAssetAssignmentsAsyncCore(
    ...
    )
    {
        var _queryString = new Samsara.Net.Core.QueryStringBuilder.Builder(capacity: 4)
            .Add("includeExternalIds", request.IncludeExternalIds)
            .Add("assetIds", request.AssetIds)
            .Add("assigneeIds", request.AssigneeIds)
            .Add("after", request.After)
            .MergeAdditional(options?.AdditionalQueryParameters)
            .Build();
        var _headers = await new Samsara.Net.Core.HeadersBuilder.Builder()
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<AssetAssignmentsListAssetAssignmentsResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<AssetAssignmentsListAssetAssignmentsResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<AssetAssignmentsCreateAssetAssignmentResponseBody>
    > CreateAssetAssignmentAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<AssetAssignmentsCreateAssetAssignmentResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<AssetAssignmentsCreateAssetAssignmentResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<DriverWorkflowsListDriverWorkflowsResponseBody>
    > ListDriverWorkflowsAsyncCore(
    ...
    )
    {
        var _queryString = new Samsara.Net.Core.QueryStringBuilder.Builder(capacity: 3)
            .Add("after", request.After)
            .Add("limit", request.Limit)
            .Add("workflowType", request.WorkflowType)
            .MergeAdditional(options?.AdditionalQueryParameters)
            .Build();
        var _headers = await new Samsara.Net.Core.HeadersBuilder.Builder()
            .Add(_client.Options.Headers)
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<DriverWorkflowsListDriverWorkflowsResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<DriverWorkflowsListDriverWorkflowsResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<EquipmentOutputControlSetEquipmentDigitalOutputResponseBody>
    > SetEquipmentDigitalOutputAsyncCore(
    ...
    )
    {
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    ...
                    Method = HttpMethodExtensions.Patch,
                    Path = string.Format(
                        "fleet/equipment/{0}/digital-output",
                        ValueConvert.ToPathParameterString(request.Id)
                    ),
                    Body = request,
                    Headers = _headers,
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<EquipmentOutputControlSetEquipmentDigitalOutputResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<EquipmentOutputControlSetEquipmentDigitalOutputResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<FleetInstallerPhotoUploadsGetFleetInstallerPhotoUploadsResponseBody>
    > GetFleetInstallerPhotoUploadsAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<FleetInstallerPhotoUploadsGetFleetInstallerPhotoUploadsResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<FleetInstallerPhotoUploadsGetFleetInstallerPhotoUploadsResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<FunctionsStorageGetFunctionStorageFileResponseBody>
    > GetFunctionStorageFileAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<FunctionsStorageGetFunctionStorageFileResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<FunctionsStorageGetFunctionStorageFileResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<FunctionsStorageCreateFunctionStorageFileResponseBody>
    > CreateFunctionStorageFileAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<FunctionsStorageCreateFunctionStorageFileResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<FunctionsStorageCreateFunctionStorageFileResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<FunctionsStorageUpdateFunctionStorageFileResponseBody>
    > UpdateFunctionStorageFileAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<FunctionsStorageUpdateFunctionStorageFileResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<FunctionsStorageUpdateFunctionStorageFileResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<FunctionsStorageListFunctionsStorageFilesResponseBody>
    > ListFunctionsStorageFilesAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<FunctionsStorageListFunctionsStorageFilesResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<FunctionsStorageListFunctionsStorageFilesResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<EntityGroundIntelligenceIssuesServiceListIssuesResponseBody>
    > ListIssuesAsyncCore(
    ...
    )
    {
        var _queryString = new Samsara.Net.Core.QueryStringBuilder.Builder(capacity: 9)
            ...
            .Add("severities", request.Severities)
            .Add("endTime", request.EndTime)
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    BaseUrl = _client.Options.BaseUrl,
                    Method = HttpMethod.Get,
                    Path = "ground-intelligence/issues",
                    QueryString = _queryString,
                    Headers = _headers,
                    Options = options,
                },
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<EntityGroundIntelligenceIssuesServiceListIssuesResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<EntityGroundIntelligenceIssuesServiceListIssuesResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<EntityGroundIntelligenceIssuesServiceUpdateGroundIntelligenceIssueResponseBody>
    > UpdateGroundIntelligenceIssueAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<EntityGroundIntelligenceIssuesServiceUpdateGroundIntelligenceIssueResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<EntityGroundIntelligenceIssuesServiceUpdateGroundIntelligenceIssueResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<EntityWatchpointsServiceUpdateWatchpointResponseBody>
    > UpdateWatchpointAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<EntityWatchpointsServiceUpdateWatchpointResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<EntityWatchpointsServiceUpdateWatchpointResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<HubRouteTemplatesListHubRouteTemplatesResponseBody>
    > ListHubRouteTemplatesAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<HubRouteTemplatesListHubRouteTemplatesResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<HubRouteTemplatesListHubRouteTemplatesResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<HubRouteTemplatesCreateHubRouteTemplateResponseBody>
    > CreateHubRouteTemplateAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<HubRouteTemplatesCreateHubRouteTemplateResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<HubRouteTemplatesCreateHubRouteTemplateResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<HubRouteTemplatesUpdateHubRouteTemplateResponseBody>
    > UpdateHubRouteTemplateAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<HubRouteTemplatesUpdateHubRouteTemplateResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<HubRouteTemplatesUpdateHubRouteTemplateResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    )
    {
        var _queryString = new Samsara.Net.Core.QueryStringBuilder.Builder(capacity: 7)
            .Add("ids", request.Ids)
            .Add("poNumbers", request.PoNumbers)
            .Add("vendorIds", request.VendorIds)
            .Add("endTime", request.EndTime)
            .Add("startTime", request.StartTime)
            .Add("after", request.After)
            .Add("limit", request.Limit)
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<EntityPurchaseOrdersServiceListPurchaseOrdersResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<EntityPurchaseOrdersServiceListPurchaseOrdersResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<EntityPurchaseOrdersServiceCreatePurchaseOrderResponseBody>
    > CreatePurchaseOrderAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<EntityPurchaseOrdersServiceCreatePurchaseOrderResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<EntityPurchaseOrdersServiceCreatePurchaseOrderResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<EntityPurchaseOrdersServiceUpdatePurchaseOrderResponseBody>
    > UpdatePurchaseOrderAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<EntityPurchaseOrdersServiceUpdatePurchaseOrderResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<EntityPurchaseOrdersServiceUpdatePurchaseOrderResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<WorkOrdersGetWorkOrderTemplatesResponseBody>
    > GetWorkOrderTemplatesAsyncCore(
    ...
    )
    {
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    BaseUrl = _client.Options.BaseUrl,
                    Method = HttpMethod.Get,
                    Path = "maintenance/work-order-templates",
                    QueryString = _queryString,
                    Headers = _headers,
                    Options = options,
                },
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<WorkOrdersGetWorkOrderTemplatesResponseBody>(
                        responseBody
                    )!;
                return new WithRawResponse<WorkOrdersGetWorkOrderTemplatesResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<PlacesGetPlaceDeletionsResponseBody>
    > GetPlaceDeletionsAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<PlacesGetPlaceDeletionsResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<PlacesGetPlaceDeletionsResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<PlacesGetPlaceGeocodeResponseBody>> GetPlaceGeocodeAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<PlacesGetPlaceGeocodeResponseBody>(
                    responseBody
                )!;
                return new WithRawResponse<PlacesGetPlaceGeocodeResponseBody>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<PlacesGetPlaceGeofenceResponseBody>
    > GetPlaceGeofenceAsyncCore(
    ...
    )
    {
        var _queryString = new Samsara.Net.Core.QueryStringBuilder.Builder(capacity: 13)
            ...
            .Add("suggestionTypes", request.SuggestionTypes)
            .Add("sizeOrder", request.SizeOrder)
            .Add("minLatitude", request.MinLatitude)
            .Add("minLongitude", request.MinLongitude)
            .Add("maxLatitude", request.MaxLatitude)
            .Add("maxLongitude", request.MaxLongitude)
            .Add("maxAreaSquareMeters", request.MaxAreaSquareMeters)
            .Add("maxSourceVertices", request.MaxSourceVertices)
            .Add("maxVertices", request.MaxVertices)
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<PlacesGetPlaceGeofenceResponseBody>(
                    responseBody
                )!;
    ...
    /// </code></example>
    public WithRawResponseTask<AgentStudioVoiceSessionsGetVoiceSessionsResponseBody> GetVoiceSessionsAsync(
        GetVoiceSessionsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AgentStudioVoiceSessionsGetVoiceSessionsResponseBody>(
            GetVoiceSessionsAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<AgentStudioVoiceSessionsGetVoiceSessionsStreamResponseBody> GetVoiceSessionsStreamAsync(
        GetVoiceSessionsStreamRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AgentStudioVoiceSessionsGetVoiceSessionsStreamResponseBody>(
            GetVoiceSessionsStreamAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<AssetSharingAgreementsListAssetSharingAgreementsResponseBody> ListAssetSharingAgreementsAsync(
        ListAssetSharingAgreementsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AssetSharingAgreementsListAssetSharingAgreementsResponseBody>(
            ListAssetSharingAgreementsAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<AssetSharingAgreementsCreateAssetSharingAgreementResponseBody> CreateAssetSharingAgreementAsync(
        AssetSharingAgreementsCreateAssetSharingAgreementRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AssetSharingAgreementsCreateAssetSharingAgreementResponseBody>(
            CreateAssetSharingAgreementAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public async Task DeleteAssetSharingAgreementAsync(
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<AssetSharingAgreementsAcceptAssetSharingAgreementResponseBody> AcceptAssetSharingAgreementAsync(
        AcceptAssetSharingAgreementRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AssetSharingAgreementsAcceptAssetSharingAgreementResponseBody>(
            AcceptAssetSharingAgreementAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<AssetSharingAgreementsListSharedAssetsResponseBody> ListSharedAssetsAsync(
        ListSharedAssetsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AssetSharingAgreementsListSharedAssetsResponseBody>(
            ListSharedAssetsAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<AssetSharingAgreementsCreateSharedAssetsBatchResponseBody> CreateSharedAssetsBatchAsync(
        AssetSharingAgreementsCreateSharedAssetsBatchRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AssetSharingAgreementsCreateSharedAssetsBatchResponseBody>(
            CreateSharedAssetsBatchAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<AssetSharingAgreementsUpdateSharedAssetsBatchResponseBody> UpdateSharedAssetsBatchAsync(
        AssetSharingAgreementsUpdateSharedAssetsBatchRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AssetSharingAgreementsUpdateSharedAssetsBatchResponseBody>(
            UpdateSharedAssetsBatchAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </summary>
    /// <example><code>
    /// await client.BetaApIs.CancelSharedAssetsBatchAsync(
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<AssetSharingAgreementsCancelSharedAssetsBatchResponseBody> CancelSharedAssetsBatchAsync(
        AssetSharingAgreementsCancelSharedAssetsBatchRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AssetSharingAgreementsCancelSharedAssetsBatchResponseBody>(
            CancelSharedAssetsBatchAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<AssetSharingAgreementsCancelAssetSharingAgreementResponseBody> CancelAssetSharingAgreementAsync(
        CancelAssetSharingAgreementRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AssetSharingAgreementsCancelAssetSharingAgreementResponseBody>(
            CancelAssetSharingAgreementAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<AssetSharingAgreementsRejectAssetSharingAgreementResponseBody> RejectAssetSharingAgreementAsync(
        RejectAssetSharingAgreementRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AssetSharingAgreementsRejectAssetSharingAgreementResponseBody>(
            RejectAssetSharingAgreementAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<AssetAssignmentsListAssetAssignmentsResponseBody> ListAssetAssignmentsAsync(
        ListAssetAssignmentsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AssetAssignmentsListAssetAssignmentsResponseBody>(
            ListAssetAssignmentsAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<AssetAssignmentsCreateAssetAssignmentResponseBody> CreateAssetAssignmentAsync(
        AssetAssignmentsCreateAssetAssignmentRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AssetAssignmentsCreateAssetAssignmentResponseBody>(
            CreateAssetAssignmentAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public async Task UnassignAssetAssignmentAsync(
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    BaseUrl = _client.Options.BaseUrl,
                    Method = HttpMethod.Post,
                    Path = "fleet/assets/assignments/unassign",
                    Body = request,
                    Headers = _headers,
                    ContentType = "application/json",
                    Options = options,
    ...
    /// </code></example>
    public WithRawResponseTask<DriverWorkflowsListDriverWorkflowsResponseBody> ListDriverWorkflowsAsync(
        ListDriverWorkflowsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<DriverWorkflowsListDriverWorkflowsResponseBody>(
            ListDriverWorkflowsAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<EquipmentOutputControlSetEquipmentDigitalOutputResponseBody> SetEquipmentDigitalOutputAsync(
        EquipmentOutputControlSetEquipmentDigitalOutputRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<EquipmentOutputControlSetEquipmentDigitalOutputResponseBody>(
            SetEquipmentDigitalOutputAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<FleetInstallerPhotoUploadsGetFleetInstallerPhotoUploadsResponseBody> GetFleetInstallerPhotoUploadsAsync(
        GetFleetInstallerPhotoUploadsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<FunctionsStorageGetFunctionStorageFileResponseBody> GetFunctionStorageFileAsync(
        GetFunctionStorageFileRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<FunctionsStorageGetFunctionStorageFileResponseBody>(
            GetFunctionStorageFileAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<FunctionsStorageCreateFunctionStorageFileResponseBody> CreateFunctionStorageFileAsync(
        FunctionsStorageCreateFunctionStorageFileRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<FunctionsStorageCreateFunctionStorageFileResponseBody>(
            CreateFunctionStorageFileAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<FunctionsStorageUpdateFunctionStorageFileResponseBody> UpdateFunctionStorageFileAsync(
        UpdateFunctionStorageFileRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<FunctionsStorageUpdateFunctionStorageFileResponseBody>(
            UpdateFunctionStorageFileAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public async Task DeleteFunctionStorageFileAsync(
    ...
    /// </code></example>
    public WithRawResponseTask<FunctionsStorageListFunctionsStorageFilesResponseBody> ListFunctionsStorageFilesAsync(
        ListFunctionsStorageFilesRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<FunctionsStorageListFunctionsStorageFilesResponseBody>(
            ListFunctionsStorageFilesAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<EntityGroundIntelligenceIssuesServiceListIssuesResponseBody> ListIssuesAsync(
        ListIssuesRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<EntityGroundIntelligenceIssuesServiceListIssuesResponseBody>(
            ListIssuesAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<EntityGroundIntelligenceIssuesServiceUpdateGroundIntelligenceIssueResponseBody> UpdateGroundIntelligenceIssueAsync(
        EntityGroundIntelligenceIssuesServiceUpdateGroundIntelligenceIssueRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<EntityGroundIntelligenceIssuesServiceUpdateGroundIntelligenceIssueResponseBody>(
            UpdateGroundIntelligenceIssueAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<EntityWatchpointsServiceUpdateWatchpointResponseBody> UpdateWatchpointAsync(
        EntityWatchpointsServiceUpdateWatchpointRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<EntityWatchpointsServiceUpdateWatchpointResponseBody>(
            UpdateWatchpointAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<HubRouteTemplatesListHubRouteTemplatesResponseBody> ListHubRouteTemplatesAsync(
        ListHubRouteTemplatesRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<HubRouteTemplatesListHubRouteTemplatesResponseBody>(
            ListHubRouteTemplatesAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<HubRouteTemplatesCreateHubRouteTemplateResponseBody> CreateHubRouteTemplateAsync(
        HubRouteTemplatesCreateHubRouteTemplateRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<HubRouteTemplatesCreateHubRouteTemplateResponseBody>(
            CreateHubRouteTemplateAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public async Task DeleteHubRouteTemplateAsync(
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<HubRouteTemplatesUpdateHubRouteTemplateResponseBody> UpdateHubRouteTemplateAsync(
        HubRouteTemplatesUpdateHubRouteTemplateRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<HubRouteTemplatesUpdateHubRouteTemplateResponseBody>(
            UpdateHubRouteTemplateAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    {
        return new WithRawResponseTask<EntityPurchaseOrdersServiceListPurchaseOrdersResponseBody>(
            ListPurchaseOrdersAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<EntityPurchaseOrdersServiceCreatePurchaseOrderResponseBody> CreatePurchaseOrderAsync(
        EntityPurchaseOrdersServiceCreatePurchaseOrderRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<EntityPurchaseOrdersServiceCreatePurchaseOrderResponseBody>(
            CreatePurchaseOrderAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<EntityPurchaseOrdersServiceUpdatePurchaseOrderResponseBody> UpdatePurchaseOrderAsync(
        EntityPurchaseOrdersServiceUpdatePurchaseOrderRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<EntityPurchaseOrdersServiceUpdatePurchaseOrderResponseBody>(
            UpdatePurchaseOrderAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<WorkOrdersGetWorkOrderTemplatesResponseBody> GetWorkOrderTemplatesAsync(
        GetWorkOrderTemplatesRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<WorkOrdersGetWorkOrderTemplatesResponseBody>(
            GetWorkOrderTemplatesAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<PlacesGetPlaceDeletionsResponseBody> GetPlaceDeletionsAsync(
        GetPlaceDeletionsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<PlacesGetPlaceDeletionsResponseBody>(
            GetPlaceDeletionsAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<PlacesGetPlaceGeocodeResponseBody> GetPlaceGeocodeAsync(
        GetPlaceGeocodeRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<PlacesGetPlaceGeocodeResponseBody>(
            GetPlaceGeocodeAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<PlacesGetPlaceGeofenceResponseBody> GetPlaceGeofenceAsync(
        GetPlaceGeofenceRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
