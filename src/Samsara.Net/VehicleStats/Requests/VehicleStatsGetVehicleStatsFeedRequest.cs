...
public record VehicleStatsGetVehicleStatsFeedRequest
{
    /// <summary>
    ...
    /// </summary>
    public IEnumerable<VehicleStatsGetVehicleStatsFeedRequestTypesItem> Types { get; set; } =
        new List<VehicleStatsGetVehicleStatsFeedRequestTypesItem>();
    ...
    /// - `seatbeltDriver`: Seatbelt Driver Status as read from the vehicle. `Buckled` or `Unbuckled`. (Beta only)
    /// </summary>
    public IEnumerable<VehicleStatsGetVehicleStatsFeedRequestDecorationsItem> Decorations { get; set; } =
        new List<VehicleStatsGetVehicleStatsFeedRequestDecorationsItem>();
