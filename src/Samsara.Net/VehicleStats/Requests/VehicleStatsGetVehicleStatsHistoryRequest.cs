...
public record VehicleStatsGetVehicleStatsHistoryRequest
{
    /// <summary>
    ...
    /// </summary>
    public IEnumerable<VehicleStatsGetVehicleStatsHistoryRequestTypesItem> Types { get; set; } =
        new List<VehicleStatsGetVehicleStatsHistoryRequestTypesItem>();
    ...
    /// - `seatbeltDriver`: Seatbelt Driver Status as read from the vehicle. `Buckled` or `Unbuckled`. (Beta only)
    /// </summary>
    public IEnumerable<VehicleStatsGetVehicleStatsHistoryRequestDecorationsItem> Decorations { get; set; } =
        new List<VehicleStatsGetVehicleStatsHistoryRequestDecorationsItem>();
