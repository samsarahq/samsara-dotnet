...
public record VehicleStatsGetHistoryRequest
{
    /// <summary>
    ...
    /// </summary>
    public IEnumerable<VehicleStatsGetHistoryRequestTypesItem> Types { get; set; } =
        new List<VehicleStatsGetHistoryRequestTypesItem>();
    ...
    /// - `seatbeltDriver`: Seatbelt Driver Status as read from the vehicle. `Buckled` or `Unbuckled`. (Beta only)
    /// </summary>
    public IEnumerable<VehicleStatsGetHistoryRequestDecorationsItem> Decorations { get; set; } =
        new List<VehicleStatsGetHistoryRequestDecorationsItem>();
