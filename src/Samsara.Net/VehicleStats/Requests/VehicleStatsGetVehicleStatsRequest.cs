...
public record VehicleStatsGetVehicleStatsRequest
{
    /// <summary>
    ...
    /// </summary>
    public IEnumerable<VehicleStatsGetVehicleStatsRequestTypesItem> Types { get; set; } =
        new List<VehicleStatsGetVehicleStatsRequestTypesItem>();
