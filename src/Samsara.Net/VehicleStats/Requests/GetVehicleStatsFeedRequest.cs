...
[Serializable]
public record GetVehicleStatsFeedRequest
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<GetVehicleStatsFeedRequestTypesItem> Types { get; set; } =
        new List<GetVehicleStatsFeedRequestTypesItem>();
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<GetVehicleStatsFeedRequestDecorationsItem> Decorations { get; set; } =
        new List<GetVehicleStatsFeedRequestDecorationsItem>();
