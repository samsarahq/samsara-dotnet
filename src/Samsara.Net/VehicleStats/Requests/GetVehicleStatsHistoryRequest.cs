...
[Serializable]
public record GetVehicleStatsHistoryRequest
{
    /// <summary>
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<GetVehicleStatsHistoryRequestTypesItem> Types { get; set; } =
        new List<GetVehicleStatsHistoryRequestTypesItem>();
    ...
    /// </summary>
    [JsonIgnore]
    public IEnumerable<GetVehicleStatsHistoryRequestDecorationsItem> Decorations { get; set; } =
        new List<GetVehicleStatsHistoryRequestDecorationsItem>();
