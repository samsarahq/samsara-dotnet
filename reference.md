...
<details><summary><code>client.BetaApIs.<a href="/src/Samsara.Net/BetaApIs/BetaApIsClient.cs">PostTrainingAssignmentsAsync</a>(PostTrainingAssignmentsRequest { ... }) -> WithRawResponseTask&lt;TrainingAssignmentsPostTrainingAssignmentsResponseBody&gt;</code></summary>
<dl>
<dd>
...
<details><summary><code>client.BetaApIs.<a href="/src/Samsara.Net/BetaApIs/BetaApIsClient.cs">DeleteTrainingAssignmentsAsync</a>(DeleteTrainingAssignmentsRequest { ... })</code></summary>
<dl>
<dd>
...
```csharp
await client.BetaApIs.DeleteTrainingAssignmentsAsync(new DeleteTrainingAssignmentsRequest());
```
</dd>
</dl>
</dd>
...
<details><summary><code>client.BetaApIs.<a href="/src/Samsara.Net/BetaApIs/BetaApIsClient.cs">PatchTrainingAssignmentsAsync</a>(PatchTrainingAssignmentsRequest { ... }) -> WithRawResponseTask&lt;TrainingAssignmentsPatchTrainingAssignmentsResponseBody&gt;</code></summary>
<dl>
<dd>
...
```csharp
await client.BetaApIs.PatchTrainingAssignmentsAsync(
...
<details><summary><code>client.BetaApIs.<a href="/src/Samsara.Net/BetaApIs/BetaApIsClient.cs">GetTrainingAssignmentsStreamAsync</a>(GetTrainingAssignmentsStreamRequest { ... }) -> WithRawResponseTask&lt;TrainingAssignmentsGetTrainingAssignmentsStreamResponseBody&gt;</code></summary>
<dl>
<dd>
...
<details><summary><code>client.BetaApIs.<a href="/src/Samsara.Net/BetaApIs/BetaApIsClient.cs">GetTrainingCoursesAsync</a>(GetTrainingCoursesRequest { ... }) -> WithRawResponseTask&lt;TrainingCoursesGetTrainingCoursesResponseBody&gt;</code></summary>
<dl>
<dd>
...
```csharp
await client.BetaApIs.GetTrainingCoursesAsync(new GetTrainingCoursesRequest());
```
</dd>
</dl>
</dd>
